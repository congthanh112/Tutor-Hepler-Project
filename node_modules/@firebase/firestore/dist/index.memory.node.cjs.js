            ...
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, asyncQueue.enqueue(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                            var maybeDoc, e_10, firestoreError;
                            return tslib.__generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        _e.trys.push([0, 2, , 3]);
                                    ...
                                    case 2:
                                        e_10 = _e.sent();
                                        firestoreError = wrapInUserErrorIfRecoverable(e_10, "Failed to get document '" + docKey + " from cache");
        ...
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    deferred = new Deferred();
                    return [4 /*yield*/, asyncQueue.enqueue(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                            var queryResult, view, viewDocChanges, viewChange, e_11, firestoreError;
                            return tslib.__generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        _e.trys.push([0, 2, , 3]);
                                    ...
                                    case 2:
                                        e_11 = _e.sent();
                                        firestoreError = wrapInUserErrorIfRecoverable(e_11, "Failed to execute query '" + query + " against cache");
                                        deferred.reject(firestoreError);
                                        return [3 /*break*/, 3];
                                    case 3: return [2 /*return*/];
                                }
