...
var SimpleDb = /** @class */ (function () {
    function SimpleDb(db) {
        this.db = db;
        var iOSVersion = SimpleDb.getIOSVersion(util$1.getUA());
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        e_4 = _e.sent();
                        if (isIndexedDbTransactionError(e_4)) {
                            logDebug(LOG_TAG$7, 'Operation failed with retryable error: ' + e_4);
                        }
                        else {
                            throw e_4; // Failure will be handled by AsyncQueue
                        }
                        return [3 /*break*/, 4];
                    case 4:
                        if (this.retryableOps.length > 0) {
...
var SyncEngineImpl = /** @class */ (function () {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 5:
                        e_5 = _e.sent();
                        error = wrapInUserErrorIfRecoverable(e_5, "Failed to persist write");
    ...
    SyncEngineImpl.prototype.registerPendingWritesCallback = function (callback) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var highestBatchId, callbacks, e_6, firestoreError;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 3:
                        e_6 = _e.sent();
                        firestoreError = wrapInUserErrorIfRecoverable(e_6, 'Initialization of waitForPendingWrites() operation failed');
        ...
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    return [4 /*yield*/, syncEngineImpl.localStore.executeQuery(queryView.query, 
                        /* usePreviousResults= */ true)];
                case 1:
                    queryResult = _e.sent();
        ...
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, syncEngineImpl.remoteStore.fillWritePipeline()];
                case 2:
                    // If we are the primary client, we need to send this write to the
                    // backend. Secondary clients will ignore these writes since their remote
                    // connection is disabled.
                ...
                case 3:
                    ...
                    _e.label = 4;
                case 4: return [4 /*yield*/, syncEngineImpl.emitNewSnapsAndNotifyLocalStore(documents)];
                case 5:
                    _e.sent();
                    return [2 /*return*/];
            }
        ...
        return tslib.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, syncEngineImpl.remoteStore.applyPrimaryState(true)];
                case 2:
                    _e.sent();
                ...
                case 5:
                    ...
                    return [4 /*yield*/, syncEngineImpl.remoteStore.applyPrimaryState(false)];
                case 6:
                    _e.sent();
                    _e.label = 7;
        ...
        return tslib.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, syncEngineImpl.localStore.allocateTarget(queryToTarget(queries[0]))];
                case 2:
                ...
                case 8:
                    target = _f.sent();
                    return [4 /*yield*/, syncEngineImpl.localStore.allocateTarget(target)];
                case 9:
                    targetData = _f.sent();
                    return [4 /*yield*/, syncEngineImpl.initializeViewAndComputeSnapshot(synthesizeTargetToQuery(target), targetId, 
                        /*current=*/ false)];
                case 10:
                    _f.sent();
                    _f.label = 11;
        ...
        return tslib.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, syncEngineImpl.emitNewSnapsAndNotifyLocalStore(changes, synthesizedRemoteEvent)];
                case 3:
                    _f.sent();
                    return [3 /*break*/, 7];
                case 4: return [4 /*yield*/, syncEngineImpl.localStore.releaseTarget(targetId, 
                    /* keepPersistedTargetData */ true)];
                case 5:
                    _f.sent();
    ...
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    targetData = _f.sent();
                    return [4 /*yield*/, syncEngineImpl.initializeViewAndComputeSnapshot(synthesizeTargetToQuery(target), targetData.targetId, 
                        /*current=*/ false)];
                case 4:
                    _f.sent();
                    syncEngineImpl.remoteStore.listen(targetData);
                        ...
                        return tslib.__generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, syncEngineImpl.localStore
                                            .releaseTarget(targetId, /* keepPersistedTargetData */ false)
                                            .then(function () {
                                            syncEngineImpl.remoteStore.unlisten(targetId);
                                            syncEngineImpl.removeAndCleanupTarget(targetId);
...
var DatastoreImpl = /** @class */ (function (_super) {
    ...
    function DatastoreImpl(credentials, serializer) {
        var _this = _super.call(this) || this;
    ...
    DatastoreImpl.prototype.start = function (connection) {
        this.connection = connection;
    };
    ...
    DatastoreImpl.prototype.termiate = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            return tslib.__generator(this, function (_e) {
...
var RemoteStore = /** @class */ (function () {
    ...
    RemoteStore.prototype.onWatchStreamChange = function (watchChange, snapshotVersion) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var e_7, lastRemoteSnapshotVersion, e_8;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 3:
                        e_7 = _e.sent();
                        logDebug(LOG_TAG$b, 'Failed to remove targets %s: %s ', watchChange.targetIds.join(','), e_7);
                    ...
                    case 11:
                        e_8 = _e.sent();
                        logDebug(LOG_TAG$b, 'Failed to raise snapshot:', e_8);
    ...
    RemoteStore.prototype.fillWritePipeline = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var lastBatchIdRetrieved, batch, e_9;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 4:
                        e_9 = _e.sent();
                        return [4 /*yield*/, this.disableNetworkUntilRecovery(e_9)];
                    case 5:
                        _e.sent();
                        return [3 /*break*/, 6];
...
var EventManager = /** @class */ (function () {
    ...
    EventManager.prototype.listen = function (listener) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var query, firstListen, queryInfo, _e, e_10, firestoreError, raisedEvent, raisedEvent_1;
            return tslib.__generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
...
var MultiTabOfflineComponentProvider = /** @class */ (function (_super) {
    ...
    MultiTabOfflineComponentProvider.prototype.createSharedClientState = function (cfg) {
        if (cfg.persistenceSettings.durable &&
            ...
            var window_2 = getWindow();
            if (!WebStorageSharedClientState.isAvailable(window_2)) {
                throw new FirestoreError(Code.UNIMPLEMENTED, 'IndexedDB persistence is only available on platforms that support LocalStorage.');
            }
            var persistenceKey = indexedDbStoragePrefix(cfg.databaseInfo.databaseId, cfg.databaseInfo.persistenceKey);
            return new WebStorageSharedClientState(window_2, cfg.asyncQueue, persistenceKey, cfg.clientId, cfg.initialUser);
        }
        return new MemorySharedClientState();
    };
...
var OnlineComponentProvider = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.loadConnection(cfg)];
                    case 1:
                        connection = _e.sent();
    ...
    OnlineComponentProvider.prototype.loadConnection = function (cfg) {
