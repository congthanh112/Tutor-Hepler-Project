...
var w$1 = "7.17.2-20207421553", b = new Logger("@firebase/firestore");
...
function I$1(t) {
    ...
    if (b.logLevel <= LogLevel.DEBUG) {
        var i = e.map(T$1);
        b.debug.apply(b, __spreadArrays([ "Firestore (" + w$1 + "): " + t ], i));
    }
}
...
function N$1(t) {
    ...
    if (b.logLevel <= LogLevel.ERROR) {
        var i = e.map(T$1);
        b.error.apply(b, __spreadArrays([ "Firestore (" + w$1 + "): " + t ], i));
    }
}
...
function A$1(t) {
    ...
    if (b.logLevel <= LogLevel.WARN) {
        var i = e.map(T$1);
        b.warn.apply(b, __spreadArrays([ "Firestore (" + w$1 + "): " + t ], i));
    }
}
...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "i", {
        ...
        return O$1(this.projectId, t.projectId) || O$1(this.database, t.database);
    }, t;
}();
 ...
 */ var M$1 = /** @class */ function() {
...
}(Error), G$1 = /** @class */ function() {
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new x$1(F$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new x$1(F$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new x$1(F$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new x$1(F$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    return t.now = function() {
        ...
        return this.seconds === t.seconds ? O$1(this.nanoseconds, t.nanoseconds) : O$1(this.seconds, t.seconds);
    ...
    n.N = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(z), K$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, W$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.V = function(t, e, r) {
    ...
    n.M = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new x$1(F$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new x$1(F$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new x$1(F$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.k = function() {
        return new n([]);
    }, n;
}(z), Q$1 = /** @class */ function() {
    function t(t) {
        this.path = t;
    }
...
function Z$1(t, e) {
    ...
    for (var n = 0; n < t.orderBy.length; n++) if (!Ln(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (var r = 0; r < t.filters.length; r++) if (i = t.filters[r], o = e.filters[r], 
    i.op !== o.op || !i.field.isEqual(o.field) || !Ft(i.value, o.value)) return !1;
    var i, o;
    return t.collectionGroup === e.collectionGroup && !!t.path.isEqual(e.path) && !!Rn(t.startAt, e.startAt) && Rn(t.endAt, e.endAt);
}

function tt(t) {
    return Q$1.W(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
...
var nt, rt, it = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = j.min()), void 0 === o && (o = j.min()), void 0 === s && (s = et.Y), 
 ...
 *     Code.UNKNOWN.
 */ (rt = nt || (nt = {}))[rt.OK = 0] = "OK", rt[rt.CANCELLED = 1] = "CANCELLED", 
...
var at = /** @class */ function() {
    ...
    t.prototype.at = function() {
        return new ct(this.root, null, this.P, !1);
    }, t.prototype.ut = function(t) {
        return new ct(this.root, t, this.P, !1);
    }, t.prototype.ct = function() {
        return new ct(this.root, null, this.P, !0);
    }, t.prototype.lt = function(t) {
        return new ct(this.root, t, this.P, !0);
    }, t;
}(), ct = /** @class */ function() {
    function t(t, e, n, r) {
        this._t = r, this.ft = [];
    ...
    t.prototype.Et = function() {
        var t = this;
        return t.right.Rt() && !t.left.Rt() && (t = t.pt()), t.left.Rt() && t.left.left.Rt() && (t = t.Pt()), 
        t.left.Rt() && t.right.Rt() && (t = t.yt()), t;
    }, t.prototype.At = function() {
        var t = this.yt();
        return t.right.left.Rt() && (t = (t = (t = t.copy(null, null, null, null, t.right.Pt())).pt()).yt()), 
        t;
    }, t.prototype.Vt = function() {
        var t = this.yt();
        return t.left.left.Rt() && (t = (t = t.Pt()).yt()), t;
    ...
    t.prototype.vt = function() {
        if (this.Rt() && this.left.Rt()) throw _();
        if (this.right.Rt()) throw _();
        var t = this.left.vt();
        if (t !== this.right.vt()) throw _();
...
var mt = new at(Q$1.P), wt = new ft(Q$1.P);

function bt() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = wt, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var Nt = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.$t = gt(), this.Nt = new at(this.P)
        /**
    ...
    function t(t, e, n, r, i, o, s, u) {
        this.query = t, this.docs = e, this.Ot = n, this.docChanges = r, this.qt = i, this.fromCache = o, 
        this.Mt = s, this.Ut = u
    ...
    return t.Bt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Mt === t.Mt && this.qt.isEqual(t.qt) && vn(this.query, t.query) && this.docs.isEqual(t.docs) && this.Ot.isEqual(t.Ot))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Dt.Kt(e, n)), new t(j.min(), r, It(), dt(), bt());
    }, t;
}(), Dt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = et.Y), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    return t.prototype.Pe = function(t) {
        for (var e = 0, n = t.Zt; e < n.length; e++) {
            var r = n[e];
            t.te instanceof rn ? this.Ve(r, t.te) : t.te instanceof on && this.pe(r, t.key, t.te);
        }
        for (var i = 0, o = t.removedTargetIds; i < o.length; i++) {
            var s = o[i];
            this.pe(s, t.key, t.te);
        }
    }, 
    ...
    t.prototype.Ce = function(t) {
        ...
        if (r) {
            ...
            if (tt(i)) if (0 === n) {
                ...
                this.pe(e, o, new on(o, j.min()));
            } else D$1(1 === n); else this.Fe(e) !== n && (
    ...
    t.prototype.$e = function(t) {
        ...
        this.Ee.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Ht && tt(o.target)) {
                    ...
                    null !== e.Ie.get(s) || e.Ne(i, s) || e.pe(i, s, new on(s, t));
                }
        ...
        var i = new _t(t, n, this.Ae, this.Ie, r);
        return this.Ie = dt(), this.Re = Lt(), this.Ae = new ft(O$1), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.Ee.get(t);
        return e || (e = new Ot, this.Ee.set(t, e)), e;
    }, t.prototype.ke = function(t) {
        var e = this.Re.get(t);
        return e || (e = new ft(O$1), this.Re = this.Re.nt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.be = function(t) {
        ...
        return e || I$1("WatchChangeAggregator", "Detected inactive target", t), e;
    }, 
    /**
    ...
    t.prototype.Se = function(t) {
        var e = this;
        this.Ee.set(t, new Ot), this.me.xe(t).forEach((function(n) {
 ...
 */ function qt(t) {
    ...
    return new G$1(e.seconds, e.nanos);
}
...
/** Extracts the backend's type order for the provided value. */ function Mt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? St(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : _();
}
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === r ? H$1(n) === H$1(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return P$1(t.arrayValue.values || [], e.arrayValue.values || [], Ft);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (S$1(n) !== S$1(r)) return !1;
...
function Gt(t, e) {
    var n = Mt(t), r = Mt(e);
    if (n !== r) return O$1(n, r);
    switch (n) {
      case 0 /* NullValue */ :
        return 0;

      case 1 /* BooleanValue */ :
        return O$1(t.booleanValue, e.booleanValue);
      ...
      case 5 /* StringValue */ :
        return O$1(t.stringValue, e.stringValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return O$1(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = O$1(Kt(t.latitude), Kt(e.latitude));
            return 0 !== n ? n : O$1(Kt(t.longitude), Kt(e.longitude));
...
function jt(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return O$1(t, e);
    var n = Bt(t), r = Bt(e), i = O$1(n.seconds, r.seconds);
    return 0 !== i ? i : O$1(n.nanos, r.nanos);
}
...
function zt(t) {
    return function t(e) {
        ...
        Q$1.U(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function fe(t, e) {
    ...
    return D$1(r.get(1) === t.s.projectId), D$1(!r.get(3) && !t.s.database || r.get(3) === t.s.database), 
    new Q$1((D$1((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
...
function ge(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = le(t, r), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = le(t, r.g()), n.structuredQuery.from = [ {
        collectionId: r.S()
    } ]);
    var i = function(t) {
        if (0 !== t.length) {
 ...
 */ function Ne(t, e, n) {
    ...
    }(n, e) : t instanceof De ? Ve(t, e) : t instanceof ke ? Re(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Te(t, e), r = Pe(n) + Pe(t.Me);
        return Yt(n) && Yt(t.Me) ? ne(r) : re(t.serializer, r);
    }(t, e);
}
 ...
 */ function Ae(t, e, n) {
    ...
    // applications.
    return t instanceof De ? Ve(t, e) : t instanceof ke ? Re(t, e) : n;
}
 ...
 */ function Te(t, e) {
    return t instanceof Oe ? Yt(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var _e = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n;
}(Ie), De = /** @class */ function(e) {
    function n(t) {
        var n = this;
 ...
 */ var Oe = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).serializer = t, r.Me = n, r;
    }
    return __extends(n, e), n;
}(Ie);
...
/** The result of successfully applying a mutation to the backend. */ var qe = function(
/**
 ...
 */ function xe(t, e, n) {
    return t instanceof Ke ? function(t, e, n) {
        ...
        if (D$1(null != n.transformResults), !Me(t.Be, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */
        function(t, e, n) {
            var r = [];
            D$1(t.length === n.length);
            for (var i = 0; i < n.length; i++) {
                var o = t[i], s = o.transform, u = null;
                e instanceof rn && (u = e.field(o.field)), r.push(Ae(s, u, n[i]));
            }
            return r;
 ...
 */ function Ge(t, e, n, r) {
    return t instanceof Ke ? function(t, e) {
    ...
    }(t, e) : t instanceof Ye ? function(t, e, n, r) {
        if (!Me(t.Be, e)) return e;
        var i = He(t, e), o = function(t, e, n, r) {
            for (var i = [], o = 0, s = t; o < s.length; o++) {
                ...
                c = r.field(u.field)), i.push(Ne(a, c, e));
            }
            return i;
        ...
        return Me(t.Be, e) ? new on(t.key, j.min()) : e;
    }(t, e);
}
 ...
 */ function je(t, e) {
    return t instanceof Ye ? function(t, e) {
        for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
            var o = i[r], s = e instanceof rn ? e.field(o.field) : void 0, u = Te(o.transform, s || null);
...
function ze(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Be.isEqual(e.Be) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || P$1(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof De && e instanceof De || t instanceof ke && e instanceof ke ? P$1(t.elements, e.elements, Ft) : t instanceof Oe && e instanceof Oe ? Ft(t.Me, e.Me) : t instanceof _e && e instanceof _e;
 ...
 */ function Be(t) {
    return t instanceof rn ? t.version : j.min();
}
 ...
 */ var Ke = /** @class */ function(e) {
    ...
    return __extends(n, e), n;
}(Fe), We = /** @class */ function(e) {
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this) || this).key = t, o.data = n, o.qe = r, o.Be = i, o.type = 1 /* Patch */ , 
        o;
    }
    return __extends(n, e), n;
}(Fe);
...
function Qe(t, e) {
    ...
    }(t, e instanceof rn ? e.data() : Ze.empty());
}

var Ye = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
/** A mutation that deletes the document at the given key. */ var Xe = /** @class */ function(e) {
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.ze = function() {
        var t = this.Xe(W$1.k(), this.He);
        return null != t ? new Ze(t) : this.Ke;
    }, 
    /**
    ...
    t.prototype.Xe = function(t, e) {
        var n = this, r = !1, i = this.Ke.field(t), o = Jt(i) ? // If there is already data at the current path, base our
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (!(t instanceof e)) throw e.name === t.constructor.name ? new x$1(F$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass '" + e.name + "' from a different Firestore SDK?") : new x$1(F$1.INVALID_ARGUMENT, "Expected type '" + e.name + "', but was '" + t.constructor.name + "'");
    return t;
}
 ...
 */ var an = /** @class */ function() {
     ...
     */    return t.prototype.rn = function(e) {
        ...
        return !Y$1(this.limit) && "F" /* First */ === this.en;
    }, t.prototype.an = function() {
        return !Y$1(this.limit) && "L" /* Last */ === this.en;
 ...
 */ function fn(t) {
    ...
    if (null === e.nn) {
        ...
        n.O() || e.nn.push(new On(n)), e.nn.push(new On(W$1.q(), "asc" /* ASCENDING */)); else {
 ...
 */ function ln(t) {
    var e = un(t, an);
    if (!e.sn) if ("F" /* First */ === e.en) e.sn = X$1(e.path, e.collectionGroup, fn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = fn(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new On(o.field, s));
        }
        ...
        // Now return as a LimitType.First query.
                e.sn = X$1(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.sn;
}

function pn(t, e, n) {
    return new an(t.path, t.collectionGroup, t.tn.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}

function dn(t, e) {
    return new an(t.path, t.collectionGroup, t.tn.slice(), t.filters.slice(), t.limit, t.en, e, t.endAt);
}

function yn(t, e) {
    return new an(t.path, t.collectionGroup, t.tn.slice(), t.filters.slice(), t.limit, t.en, t.startAt, e);
}

function vn(t, e) {
    return Z$1(ln(t), ln(e)) && t.en === e.en;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function wn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.B(t.collectionGroup) && t.path.C(n) : Q$1.W(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
        ...
        return !(t.startAt && !kn(t.startAt, fn(t), e)) && (!t.endAt || !kn(t.endAt, fn(t), e));
    }(t, e);
}
...
var En = /** @class */ function(e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        if (t.O()) return "in" /* IN */ === e ? new Nn(t, r) : new In(t, e, r);
        if ($t(r)) {
            if ("==" /* EQUAL */ !== e) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (Xt(r)) {
            if ("==" /* EQUAL */ !== e) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new An(t, r) : "in" /* IN */ === e ? new Tn(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new _n(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && Mt(this.value) === Mt(e) && this.fn(Gt(e, this.value));
...
var In = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return Ht(e) && xt(e.arrayValue, this.value);
    }, n;
}(En), Tn = /** @class */ function(e) {
    function n(t, n) {
...
/** Filter that matches on key fields within an array. */ function Vn(t) {
 ...
 */ function kn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.O() ? Q$1.P(Q$1.U(s.referenceValue), n.key) : Gt(s, n.field(o.field)), 
...
function Pn(t, e, n) {
    var r = t.field.O() ? Q$1.P(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? Gt(r, i) : _();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var Un = /** @class */ function() {
    ...
    t.prototype.mn = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Ge(i, e, e, this.dn));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = Ge(a, e, o, this.dn));
        }
        return e;
    }, 
    /**
     ...
     */
    r) {
        this.batch = t, this.In = e, this.Tn = n, this.Rn = r
        /**
    ...
    return t.from = function(e, n, r) {
        D$1(e.mutations.length === r.length);
        for (var i = mt, o = e.mutations, s = 0; s < o.length; s++) i = i.nt(o[s].key, r[s].version);
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.pn && _(), this.pn = !0, this.Vn ? this.error ? this.yn(n, this.error) : this.gn(e, this.result) : new t((function(t, i) {
            r.An = function(n) {
                r.gn(e, n).next(t, i);
            }, r.Pn = function(e) {
                r.yn(n, e).next(t, i);
    ...
    return t.prototype.Nn = function(t, e) {
        var n = this;
        return this.Fn.kn(t, e).next((function(r) {
            return n.xn(t, e, r);
        }));
    }, 
    /** Internal version of `getDocument` that allows reusing batches. */ t.prototype.xn = function(t, e, n) {
        return this.Dn.Ln(t, e).next((function(t) {
            for (var r = 0, i = n; r < i.length; r++) {
                t = i[r].mn(e, t);
            }
            return t;
    ...
    t.prototype.qn = function(t, e) {
        var n = this;
        return this.Dn.getEntries(t, e).next((function(e) {
            return n.Mn(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.Mn = function(t, e) {
        var n = this;
        return this.Fn.Un(t, e).next((function(r) {
            var i = n.On(t, e, r), o = dt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new on(t, j.min())), o = o.nt(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        ...
        // Query the remote documents and overlay mutations.
                return this.Dn.Bn(t, e, n).next((function(n) {
            return r = n, o.Fn.zn(t, e);
        })).next((function(e) {
            return i = e, o.Kn(t, i, r).next((function(t) {
                r = t;
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = Ge(a, h, h, o.dn);
                    r = f instanceof rn ? r.nt(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        for (var r = bt(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
            a instanceof We && null === n.get(a.key) && (r = r.add(a.key));
        }
        var c = n;
        return this.Dn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof rn && (c = c.nt(t, e));
            })), c;
        }));
    }, t;
}(), Mn = /** @class */ function() {
    function t(t, e, n, r) {
        this.targetId = t, this.fromCache = e, this.Hn = n, this.Yn = r;
    }
    return t.Xn = function(e, n) {
        for (var r = bt(), i = bt(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    function t(t, e) {
        var n = this;
        this.previousValue = t, e && (e.Jn = function(t) {
            return n.Zn(t);
        }, this.ts = function(t) {
            return e.es(t);
        });
    ...
    return t.prototype.Zn = function(t) {
        ...
        return this.ts && this.ts(t), t;
    }, t;
}();

/** The result of applying a mutation batch to the backend. */ Fn.ns = -1;
...
var xn = function() {
     ...
     */ , i) {
        ...
        this.ss = t, this.rs = e, this.os = n, this.hs = r, this.as = i, this.us = 0, this.cs = null, 
        /** The last backoff attempt, as epoch milliseconds. */
        this.ls = Date.now(), this.reset();
    }
    /**
    ...
    t.prototype.fs = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.us + this.ds()), r = Math.max(0, Date.now() - this.ls), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && I$1("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.us + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
        this.cs = this.ss.ws(this.rs, i, (function() {
            return e.ls = Date.now(), t();
        })), 
        // Apply backoff factor to determine next delay and ensure it is within
        // bounds.
        this.us *= this.hs, this.us < this.os && (this.us = this.os), this.us > this.as && (this.us = this.as);
    }, t.prototype.Ts = function() {
        null !== this.cs && (this.cs.ms(), this.cs = null);
    }, t.prototype.cancel = function() {
        null !== this.cs && (this.cs.cancel(), this.cs = null);
    }, 
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ t.prototype.ds = function() {
        return (Math.random() - .5) * this.us;
    }, t;
}(), jn = /** @class */ function() {
    function t() {
        this.Es = new zn;
    ...
    return t.prototype.Is = function(t, e) {
        return this.Es.add(e), qn.resolve();
    }, t.prototype.Gn = function(t, e) {
        return qn.resolve(this.Es.getEntries(e));
    }, t;
}(), zn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.S(), n = t.g(), r = this.index[e] || new ft(B.P), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.S(), n = t.g(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new ft(B.P)).F();
    }, t;
}(), Bn = /** @class */ function() {
    function t(t) {
        this.Rs = t;
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function Wn() {
 ...
 */ var Qn = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Vs = t, this.rs = e, this.ps = n, this.op = r, this.ys = i, this.gs = new xn, 
        this.then = this.gs.promise.then.bind(this.gs.promise), 
        // It's normal for the deferred promise to be canceled (due to cancellation)
        // and so we attach a dummy catch callback to avoid
        // 'UnhandledPromiseRejectionWarning' log spam.
        this.gs.promise.catch((function(t) {}))
        /**
    ...
    t.prototype.cancel = function(t) {
        null !== this.bs && (this.clearTimeout(), this.gs.reject(new x$1(F$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }, t.prototype.Ss = function() {
        var t = this;
        this.Vs.Cs((function() {
            return null !== t.bs ? (t.clearTimeout(), t.op().then((function(e) {
                return t.gs.resolve(e);
            }))) : Promise.resolve();
        }));
    }, t.prototype.clearTimeout = function() {
        null !== this.bs && (this.ys(this), clearTimeout(this.bs), this.bs = null);
    }, t;
}(), Yn = /** @class */ function() {
    function t() {
        var t = this;
        ...
        this.Os = new Gn(this, "async_queue_retry" /* AsyncQueueRetry */), 
        ...
        var e = Wn();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.qs);
    }
    ...
    t.prototype.js = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Bs(), this.$s ? [ 3 /*break*/ , 2 ] : (this.$s = !0, (e = Wn()) && e.removeEventListener("visibilitychange", this.qs), 
                    [ 4 /*yield*/ , this.Qs(t) ]);
    ...
    t.prototype.enqueue = function(t) {
        return this.Bs(), this.$s ? new Promise((function(t) {})) : this.Ws(t);
    }, 
    /**
    ...
    t.prototype.Gs = function(t) {
        var e = this;
        this.Fs.push(t), this.Cs((function() {
            return e.zs();
        }));
    }, 
    /**
    ...
    t.prototype.zs = function() {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.Fs.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Fs[0]() ];

                  case 2:
                    return n.sent(), this.Fs.shift(), this.Os.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!Kn(t = n.sent())) throw t;
                    // Failure will be handled by AsyncQueue
                                        return I$1("AsyncQueue", "Operation failed with retryable error: " + t), 
                    [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.Ds.then((function() {
            return e.xs = !0, t().catch((function(t) {
                // Re-throw the error so that this.tail becomes a rejected Promise and
                // all further attempts to chain (via .then) will just short-circuit
                // and return the rejected Promise.
                throw e.ks = t, e.xs = !1, N$1("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.ws = function(t, e, n) {
        ...
        this.Ls.indexOf(t) > -1 && (e = 0);
        var i = Qn.vs(this, t, e, n, (function(t) {
            return r.Ks(t);
        }));
        return this.Ns.push(i), i;
    ...
    t.prototype.Xs = function(t) {
        for (var e = 0, n = this.Ns; e < n.length; e++) {
            if (n[e].rs === t) return !0;
        }
        return !1;
    }, 
    /**
    ...
    t.prototype.Js = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
                return this.Ys().then((function() {
            // Run ops in the same order they'd run if they ran naturally.
            e.Ns.sort((function(t, e) {
                return t.ps - e.ps;
            }));
            for (var n = 0, r = e.Ns; n < r.length; n++) {
                var i = r[n];
                if (i.ms(), "all" /* All */ !== t && i.rs === t) break;
            }
            return e.Ys();
        }));
    }, 
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.Ks = function(t) {
        // NOTE: indexOf / slice are O(n), but delayedOperations is expected to be small.
        var e = this.Ns.indexOf(t);
        this.Ns.splice(e, 1);
    }, t;
}();
 ...
 */
function Hn(t, e) {
    if (N$1("AsyncQueue", e + ": " + t), Kn(t)) return new x$1(F$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var $n = /** @class */ function() {
    ...
    n) {
        this.ti = t, this.ei = e, this.ni = n;
    }
    return t.si = function(e) {
        return new t(e, t.ii, t.ri);
    }, t;
}();

$n.oi = -1, $n.hi = 1048576, $n.ai = 41943040, $n.ii = 10, $n.ri = 1e3, $n.ui = new $n($n.ai, $n.ii, $n.ri), 
$n.ci = new $n($n.oi, 0, 0);
...
var Xn = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.di = j.min(), this.Fn = t.wi(n), this.Ti = t.mi(), this.Ei = t.Ii(), this.Ri = new Cn(this.Ti, this.Fn, this.persistence.Ai()), 
        this.li.Pi(this.Ri);
    }
    return t.prototype.Vi = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Fn, r = this.Ri, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.Fn.pi(n).next((function(s) {
                            return i = s, e = o.persistence.wi(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new Cn(o.Ti, e, o.persistence.Ai()), e.pi(n);
                        })).next((function(t) {
                            for (var e = [], o = [], s = bt(), u = 0, a = i
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.Fn = e, this.Ri = r, this.li.Pi(this.Ri), 
                    i) ];
                }
            }));
        }));
    }, t.prototype.bi = function(t) {
        var e, n = this, r = G$1.now(), i = t.reduce((function(t, e) {
            return t.add(e.key);
        }), bt());
        ...
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(n) {
            ...
            return e.Ni(n, t, i).next((function() {
                return i.apply(n);
            })).next((function() {
                return e.Fn.ki(n);
            })).next((function() {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            var r;
            return e.Fn.Li(n, t).next((function(t) {
                return D$1(null !== t), r = t.keys(), e.Fn.Oi(n, t);
            })).next((function() {
                return e.Fn.ki(n);
            })).next((function() {
                return e.Ri.qn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, c).next((function(t) {
                e.jt.forEach((function(i, c) {
                    ...
                    // cache.
                                        c instanceof on && c.version.isEqual(j.min()) ? (
                    // NoDocuments with SnapshotVersion.min() are used in manufactured
                    // events. We remove these documents from cache since we lost
                    // access.
                    s.zi(i, r), a = a.nt(i, c)) : null == h || c.version.o(h.version) > 0 || 0 === c.version.o(h.version) && h.hasPendingWrites ? (s.Ki(c, r), 
                    a = a.nt(i, c)) : I$1("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", h.version, " Watch version:", c.version), 
                    e.Gt.has(i) && u.push(n.persistence.Yi.Hi(o, i));
                }));
            }))), !r.isEqual(j.min())) {
                var h = n.Ei.Mi(o).next((function(t) {
                    return n.Ei.Xi(o, o.Qi, r);
                }));
                u.push(h);
            }
            return qn.Sn(u).next((function() {
                return s.apply(o);
            })).next((function() {
                return n.Ri.Mn(o, a);
            }));
    ...
    t.ji = function(t, e, n) {
        ...
        return D$1(e.resumeToken.H() > 0), 0 === t.resumeToken.H() || (
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return qn.forEach(t, (function(t) {
                            return qn.forEach(t.Hn, (function(n) {
                  ...
                  case 2:
                    if (!Kn(e = n.sent())) throw e;
                    // If `notifyLocalViewChanges` fails, we did not advance the sequence
                    // number for the documents that were included in this transaction.
                    // This might trigger them to be deleted earlier than they otherwise
                    // would have, but it should not invalidate the integrity of the data.
                                        return I$1("LocalStore", "Failed to update sequence numbers: " + e), 
                    [ 3 /*break*/ , 3 ];
        ...
        return this.persistence.runTransaction("Get next mutation batch", "readonly", (function(n) {
            return void 0 === t && (t = -1), e.Fn.sr(n, t);
        }));
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Ei.or(n, t).next((function(i) {
                ...
                r = i, qn.resolve(r)) : e.Ei.hr(n).next((function(i) {
                    return r = new it(t, i, 0 /* Listen */ , n.Qi), e.Ei.ar(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 4:
                    if (!Kn(o = n.sent())) throw o;
                    // All `releaseTarget` does is record the final metadata state for the
                    // target, but we've been recording this periodically during target
                    // activity. If we lose this write this could cause a very slight
                    // difference in the order of target deletion during GC, but we
                    // don't define exact LRU semantics so this is acceptable.
                                        return I$1("LocalStore", "Failed to update sequence numbers for target " + t + ": " + o), 
                    [ 3 /*break*/ , 5 ];
        ...
        return o.forEach((function(r) {
            s = s.next((function() {
                ...
                D$1(null !== s), (!o || o.version.o(s) < 0) && ((o = i.wn(r, o, e)) && 
 ...
 */ function Jn(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            if (t.code !== F$1.FAILED_PRECONDITION || "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab." !== t.message) throw t;
            return I$1("LocalStore", "Unexpectedly lost primary lease"), [ 2 /*return*/ ];
        }));
    }));
}
...
var Zn = /** @class */ function() {
    function t() {
        ...
        this.Tr = new ft(tr.mr), 
        // A set of outstanding references to a document sorted by target id.
        this.Er = new ft(tr.Ir)
    ...
    t.prototype.Vr = function(t) {
        var e = this, n = new Q$1(new B([])), r = new tr(n, t), i = new tr(n, t + 1), o = [];
        ...
        var e = new Q$1(new B([])), n = new tr(e, t), r = new tr(e, t + 1), i = bt();
        return this.Er.bt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.gr = function(t) {
        var e = new tr(t, 0), n = this.Tr.Ct(e);
    ...
    return t.mr = function(t, e) {
        return Q$1.P(t.key, e.key) || O$1(t.vr, e.vr);
    }, 
    /** Compare by ID then by key */ t.Ir = function(t, e) {
        return O$1(t.vr, e.vr) || Q$1.P(t.key, e.key);
    }, t;
}(), er = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
/** A user with a null UID. */ er.UNAUTHENTICATED = new er(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
er.Cr = new er("google-credentials-uid"), er.Dr = new er("first-party-uid");
...
var nr = function(t, e) {
    ...
    }, t.prototype.Nr = function() {}, t.prototype.kr = function(t) {
        this.$r = t, 
        // Fire with initial user.
        t(er.UNAUTHENTICATED);
    ...
    function t(t) {
        ...
        this.currentUser = er.UNAUTHENTICATED, this.Or = !1, 
        /**
        ...
        this.$r = null, this.forceRefresh = !1, this.Lr = function() {
            e.qr++, e.currentUser = e.Mr(), e.Or = !0, e.$r && e.$r(e.currentUser);
        }, this.qr = 0, this.auth = t.getImmediate({
            optional: !0
    ...
    return t.prototype.getToken = function() {
        var t = this, e = this.qr, n = this.forceRefresh;
        ...
        // request is outstanding.
            ...
            return t.qr !== e ? (I$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (D$1("string" == typeof n.accessToken), new nr(n.accessToken, t.currentUser)) : null;
        ...
        this.auth && this.auth.removeAuthTokenListener(this.Lr), this.Lr = null, this.$r = null;
    }, 
    ...
    t.prototype.Mr = function() {
        ...
        return D$1(null === t || "string" == typeof t), new er(t);
    }, t;
}(), or = /** @class */ function() {
    function t(t, e) {
        this.Ur = t, this.Br = e, this.type = "FirstParty", this.user = er.Dr;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new or(this.Ur, this.Br));
    }, t.prototype.kr = function(t) {
        // Fire with initial uid.
        t(er.Dr);
    }, t.prototype.xr = function() {}, t.prototype.Nr = function() {}, t;
}(), ur = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        this.ss = t, this.Qr = n, this.jr = r, this.Gr = i, this.listener = o, this.state = 0 /* Initial */ , 
        /**
             * A close count that's incremented every time the stream is closed; used by
             * getCloseGuardedDispatcher() to invalidate callbacks that happen after
             * close.
             */
        this.zr = 0, this.Kr = null, this.stream = null, this.Os = new Gn(t, e)
        /**
    ...
    t.prototype.Jr = function() {
        this.state = 0 /* Initial */ , this.Os.reset();
    }, 
    /**
    ...
    t.prototype.Zr = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.Yr() && null === this.Kr && (this.Kr = this.ss.ws(this.Qr, 6e4, (function() {
            return t.to();
        })));
    }, 
    ...
    /** Marks the stream as active again. */ t.prototype.no = function() {
        this.Kr && (this.Kr.cancel(), this.Kr = null);
    }, 
    /**
    ...
    t.prototype.so = function() {}, t.prototype.auth = function() {
        ...
        var e = this.ro(this.zr), n = this.zr;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new x$1(F$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.ho(e);
            }));
        }));
    }, t.prototype.oo = function(t) {
        var e = this, n = this.ro(this.zr);
        ...
        var t = this;
        this.state = 4 /* Backoff */ , this.Os.fs((function() {
    ...
    t.prototype.ho = function(t) {
        ...
        return I$1("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.ro = function(t) {
        ...
        return function(n) {
            e.ss.Cs((function() {
                return e.zr === t ? n() : (I$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return __extends(n, e), n.prototype.ao = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Oe ? (D$1(void 0 === e || "string" == typeof e), et.fromBase64String(e || "")) : (D$1(void 0 === e || e instanceof Uint8Array), 
                    et.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? F$1.UNKNOWN : ut(t.code);
                    return new x$1(e, t.message || "");
                }(s);
                ...
                var c = fe(t, a.document.name), h = ae(a.document.updateTime), f = new Ze({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = new rn(c, h, f, {}), p = a.targetIds || [], d = a.removedTargetIds || [];
                n = new Vt(p, d, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = fe(t, y.document), g = y.readTime ? ae(y.readTime) : j.min(), m = new on(v, g), w = y.removedTargetIds || [];
                n = new Vt([], w, m.key, m);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var E = fe(t, b.document), I = b.removedTargetIds || [];
                n = new Vt([], I, E, null);
            } else {
                ...
                var N = e.filter;
                N.targetId;
                var A = N.count || 0, T = new ot(A), V = N.targetId;
                n = new kt(V, T);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? j.min() : e.readTime ? ae(e.readTime) : j.min();
        }(t);
    ...
    n.prototype._o = function(t) {
        var e = {};
        e.database = pe(this.serializer), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = tt(r) ? {
                documents: ve(t, r)
            } : {
                query: ge(t, r)
            }).targetId = e.targetId, e.resumeToken.H() > 0 && (n.resumeToken = se(t, e.resumeToken)), 
            n;
        }(this.serializer, t);
        var n = function(t, e) {
            var n = function(t, e) {
    ...
    n.prototype.fo = function(t) {
        var e = {};
        e.database = pe(this.serializer), e.removeTarget = t, this.eo(e);
    }, n;
}(ur), cr = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "wo", {
        /**
    ...
    n.prototype.start = function() {
        ...
        D$1(!!t.streamToken), this.lastStreamToken = t.streamToken, this.do) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.Os.reset();
            var e = function(t, e) {
                return t && t.length > 0 ? (D$1(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        // NOTE: Deletes don't have an updateTime.
                        var n = t.updateTime ? ae(t.updateTime) : ae(e);
                        n.isEqual(j.min()) && (
            ...
            }(t.writeResults, t.commitTime), n = ae(t.commitTime);
            return this.listener.mo(n, e);
        }
        // The first response is always the handshake response
                return D$1(!t.writeResults || 0 === t.writeResults.length), this.do = !0, 
        this.listener.Eo();
    }, 
    /**
    ...
    n.prototype.Io = function() {
        ...
        var t = {};
        t.database = pe(this.serializer), this.eo(t);
    }, 
    /** Sends a group of mutations to the Firestore backend to apply. */ n.prototype.To = function(t) {
        var e = this, n = {
            streamToken: this.lastStreamToken,
            writes: t.map((function(t) {
                return ye(e.serializer, t);
            }))
        };
        this.eo(n);
    }, n;
}(ur), hr = /** @class */ function(r) {
    function i(t, e) {
        var n = this;
        return (n = r.call(this) || this).credentials = t, n.serializer = e, n.Ro = !1, 
        n;
    }
    return __extends(i, r), i.prototype.Ao = function() {
        if (this.Ro) throw new x$1(F$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, i.prototype.start = function(t) {
        this.jr = t;
    }, 
    /** Gets an auth token and invokes the provided RPC. */ i.prototype.Po = function(t, e, n) {
        var r = this;
        return this.Ao(), this.credentials.getToken().then((function(i) {
            return r.jr.Po(t, e, n, i);
        })).catch((function(t) {
            throw t.code === F$1.UNAUTHENTICATED && r.credentials.Nr(), t;
        }));
    }, 
    /** Gets an auth token and invokes the provided RPC with streamed results. */ i.prototype.Vo = function(t, e, n) {
        var r = this;
        return this.Ao(), this.credentials.getToken().then((function(i) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                return this.Ro = !1, [ 2 /*return*/ ];
            }));
        }));
    }, i;
}((function() {})), fr = /** @class */ function() {
    function t(t, e) {
        this.Vs = t, this.yo = e, 
    ...
    return t.prototype.Co = function() {
        var t = this;
        0 === this.vo && (this.Do("Unknown" /* Unknown */), this.bo = this.Vs.ws("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.bo = null, t.Fo("Backend didn't respond within 10 seconds."), t.Do("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
     ...
     */
    t.prototype.$o = function(t) {
        "Online" /* Online */ === this.state ? this.Do("Unknown" /* Unknown */) : (this.vo++, 
        this.vo >= 1 && (this.No(), this.Fo("Connection failed 1 times. Most recent error: " + t.toString()), 
        this.Do("Offline" /* Offline */)));
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        this.No(), this.vo = 0, "Online" /* Online */ === t && (
        ...
        this.So ? (N$1(e), this.So = !1) : I$1("OnlineStateTracker", e);
    ...
    r, i, o, s) {
        ...
        /**
             ...
             */
        this.Oo = new Map, this.qo = null, 
        /**
             * A set of reasons for why the RemoteStore may be offline. If empty, the
             * RemoteStore may start its network connections.
             */
        this.Mo = new Set, this.Uo = s, this.Uo.Bo((function(t) {
            i.Cs((function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Wo() ? (I$1("RemoteStore", "Restarting streams for network reachability change."), 
                            [ 4 /*yield*/ , this.Qo() ]) : [ 3 /*break*/ , 2 ];
        ...
        this.Go = function(t, e, n) {
            var r = V$1(t);
            return r.Ao(), new ar(e, r.jr, r.credentials, r.serializer, n);
        }(this.xo, i, {
            uo: this.zo.bind(this),
            io: this.Ko.bind(this),
            lo: this.Ho.bind(this)
        }), this.Yo = function(t, e, n) {
            var r = V$1(t);
            return r.Ao(), new cr(e, r.jr, r.credentials, r.serializer, n);
        }(this.xo, i, {
            uo: this.Xo.bind(this),
            io: this.Jo.bind(this),
            Eo: this.Zo.bind(this),
    ...
    /** Re-enables the network. Idempotent. */ t.prototype.enableNetwork = function() {
        return this.Mo.delete(0 /* UserDisabled */), this.th();
    }, t.prototype.th = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.Wo() ? (this.eh() ? this.nh() : this.jo.set("Unknown" /* Unknown */), 
                    [ 4 /*yield*/ , this.sh() ]) : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.disableNetwork = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.Mo.add(0 /* UserDisabled */), [ 4 /*yield*/ , this.ih() ];

                  case 1:
                    return t.sent(), 
                    // Set the OnlineState to Offline so get()s return from cache, etc.
                    this.jo.set("Offline" /* Offline */), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.Yo.stop() ];

                  case 1:
                    return t.sent(), [ 4 /*yield*/ , this.Go.stop() ];

                  case 2:
                    return t.sent(), this.Lo.length > 0 && (I$1("RemoteStore", "Stopping write stream with " + this.Lo.length + " pending writes"), 
                    this.Lo = []), this.rh(), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return I$1("RemoteStore", "RemoteStore shutting down."), this.Mo.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.ih() ];

                  case 1:
                    return t.sent(), this.Uo.oh(), 
                    // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                    // triggering spurious listener events with cached data, etc.
                    this.jo.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.listen = function(t) {
        this.Oo.has(t.targetId) || (
        // Mark this as something the client is currently listening for.
        this.Oo.set(t.targetId, t), this.eh() ? 
        // The listen will be sent in onWatchStreamOpen
        this.nh() : this.Go.Yr() && this.hh(t));
    }, 
    /**
    ...
    t.prototype.ah = function(t) {
        this.Oo.delete(t), this.Go.Yr() && this.uh(t), 0 === this.Oo.size && (this.Go.Yr() ? this.Go.Zr() : this.Wo() && 
        // Revert to OnlineState.Unknown if the watch stream is not open and we
        // have no listeners, since without any listens to send we cannot
        // confirm if the stream is healthy and upgrade to OnlineState.Online.
        this.jo.set("Unknown" /* Unknown */));
    }, 
    /** {@link TargetMetadataProvider.getTargetDataForTarget} */ t.prototype.Le = function(t) {
        return this.Oo.get(t) || null;
    }, 
    ...
    t.prototype.hh = function(t) {
        this.qo.de(t.targetId), this.Go._o(t);
    }, 
    /**
    ...
    t.prototype.uh = function(t) {
        this.qo.de(t), this.Go.fo(t);
    }, t.prototype.nh = function() {
        this.qo = new Pt(this), this.Go.start(), this.jo.Co();
    }, 
    /**
    ...
    t.prototype.eh = function() {
        return this.Wo() && !this.Go.Hr() && this.Oo.size > 0;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t = this;
            return __generator(this, (function(e) {
                return this.Oo.forEach((function(e, n) {
                    t.hh(e);
                })), [ 2 /*return*/ ];
            }));
        }));
    ...
    }, t.prototype.Ho = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.jo.set("Online" /* Online */), !(t instanceof Rt && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this._h(t) ];

                  case 2:
                    return n.sent(), [ 3 /*break*/ , 5 ];

                  case 3:
                    return e = n.sent(), I$1("RemoteStore", "Failed to remove targets %s: %s ", t.targetIds.join(","), e), 
                    [ 4 /*yield*/ , this.fh(e) ];
                  ...
                  case 6:
                    if (t instanceof Vt ? this.qo.Pe(t) : t instanceof kt ? this.qo.Ce(t) : this.qo.ye(t), 
                    r.isEqual(j.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;

                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.ko.Mi() ];

                  case 8:
                    return i = n.sent(), r.o(i) >= 0 ? [ 4 /*yield*/ , this.dh(r) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return I$1("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.fh(o) ];
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    ...
                    return this.Mo.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , this.ih() ];

                  case 1:
                    // Disable network and raise offline snapshots
                    return o.sent(), this.jo.set("Offline" /* Offline */), r || (
                    ...
                    this.Vs.Gs((function() {
                        return __awaiter(i, void 0, void 0, (function() {
                            return __generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return I$1("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , r() ];

                                  case 1:
                                    return t.sent(), this.Mo.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , this.th() ];
    ...
    t.prototype.dh = function(t) {
        ...
        return n.Wt.forEach((function(n, r) {
            if (n.resumeToken.H() > 0) {
                ...
                // A watched target might have been removed already.
                                i && e.Oo.set(r, i.tt(n.resumeToken, t));
            }
        })), 
        ...
        n.Qt.forEach((function(t) {
            ...
            if (n) {
                ...
                var r = new it(n.target, t, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                e.hh(r);
            }
        })), this.lh.Ui(n);
    }, 
    /** Handles an error on a target */ t.prototype._h = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, r, i, o;
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.Oo.has(o) ? [ 4 /*yield*/ , this.lh.Th(o, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    n.sent(), this.Oo.delete(o), this.qo.removeTarget(o), n.label = 3;
    ...
    t.prototype.sh = function() {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    t = this.Lo.length > 0 ? this.Lo[this.Lo.length - 1].batchId : -1, n.label = 1;

                  case 1:
                    if (!this.mh()) return [ 3 /*break*/ , 7 ];
                    n.label = 2;

                  case 2:
                    return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.ko.nr(t) ];

                  case 3:
                    return null === (e = n.sent()) ? (0 === this.Lo.length && this.Yo.Zr(), [ 3 /*break*/ , 7 ]) : (t = e.batchId, 
                    this.Eh(e), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = n.sent(), [ 4 /*yield*/ , this.fh(r) ];
                  ...
                  case 7:
                    return this.Ih() && this.Rh(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.mh = function() {
        return this.Wo() && this.Lo.length < 10;
    }, 
    // For testing
    ...
    t.prototype.Eh = function(t) {
        this.Lo.push(t), this.Yo.Yr() && this.Yo.wo && this.Yo.To(t.mutations);
    }, t.prototype.Ih = function() {
        return this.Wo() && !this.Yo.Hr() && this.Lo.length > 0;
    }, t.prototype.Rh = function() {
        this.Yo.start();
    }, t.prototype.Xo = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                return this.Yo.Io(), [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Zo = function() {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                ...
                for (t = 0, e = this.Lo; t < e.length; t++) r = e[t], this.Yo.To(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Lo.shift(), i = Sn.from(e, t, r), [ 4 /*yield*/ , this.wh((function() {
                        return o.lh.Ph(i);
                    })) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return t && this.Yo.wo ? [ 4 /*yield*/ , this.Vh(t) ] : [ 3 /*break*/ , 2 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return st(r = t.code) && r !== F$1.ABORTED ? (e = this.Lo.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.Yo.Jr(), [ 4 /*yield*/ , this.wh((function() {
                        return i.lh.ph(e.batchId, t);
                    })) ]) : [ 3 /*break*/ , 3 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.Mo.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , this.ih() ];

                  case 1:
                    return t.sent(), this.jo.set("Unknown" /* Unknown */), this.Yo.Jr(), this.Go.Jr(), 
                    this.Mo.delete(4 /* ConnectivityChange */), [ 4 /*yield*/ , this.th() ];
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    I$1("RemoteStore", "RemoteStore received new credentials"), this.Mo.add(3 /* CredentialChange */), 
                    [ 4 /*yield*/ , this.ih() ];

                  case 1:
                    return e.sent(), this.jo.set("Unknown" /* Unknown */), [ 4 /*yield*/ , this.lh.yh(t) ];

                  case 2:
                    return e.sent(), this.Mo.delete(3 /* CredentialChange */), [ 4 /*yield*/ , this.th() ];
    ...
    t.prototype.gh = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return t ? (this.Mo.delete(2 /* IsSecondary */), [ 4 /*yield*/ , this.th() ]) : [ 3 /*break*/ , 2 ];

                  case 1:
                    return n.sent(), [ 3 /*break*/ , 5 ];

                  case 2:
                    return (e = t) ? [ 3 /*break*/ , 4 ] : (this.Mo.add(2 /* IsSecondary */), [ 4 /*yield*/ , this.ih() ]);

                  case 3:
                    n.sent(), e = this.jo.set("Unknown" /* Unknown */), n.label = 4;
    ...
    function t() {
        this.Ch = new pr, this.Dh = {}, this.yo = null, this.Jn = null;
    }
    return t.prototype.Fh = function(t) {
        ...
        return this.Ch.vh(t), this.Dh[t] || "not-current";
    }, t.prototype.kh = function(t, e, n) {
        this.Dh[t] = e;
    }, t.prototype.xh = function(t) {
        this.Ch.bh(t);
    }, t.prototype.Lh = function(t) {
        return this.Ch.activeTargetIds.has(t);
    }, t.prototype.Oh = function(t) {
        delete this.Dh[t];
    }, t.prototype.qh = function() {
        return this.Ch.activeTargetIds;
    }, t.prototype.Mh = function(t) {
        return this.Ch.activeTargetIds.has(t);
    }, t.prototype.start = function() {
        return this.Ch = new pr, Promise.resolve();
    }, t.prototype.Vi = function(t, e, n) {
        // No op.
    }, t.prototype.Uh = function(t) {
        // No op.
    }, t.prototype.oh = function() {}, t.prototype.es = function(t) {}, t;
}(), yr = function(t) {
    this.key = t;
}, vr = function(t) {
    this.key = t;
    ...
    e) {
        this.query = t, this.Bh = e, this.Wh = null, 
        /**
        ...
        this.qt = bt(), this.jh = bn(t), this.Gh = new Nt(this.jh);
    }
    ...
    t.prototype.Kh = function(t, e) {
        var n = this, r = e ? e.Hh : new At, i = e ? e.Gh : this.Gh, o = e ? e.qt : this.qt, s = i, u = !1, a = this.query.hn() && i.size === this.query.limit ? i.last() : null, c = this.query.an() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.Jh = function(t, e, n) {
        var r = this, i = this.Gh;
        this.Gh = t.Gh, this.qt = t.qt;
        ...
        o.sort((function(t, e) {
            return function(t, e) {
                ...
                return n(t) - n(e);
            }(t.type, e.type) || r.jh(t.doc, e.doc);
        })), this.Zh(n);
        var s = e ? this.ta() : [], u = 0 === this.Qh.size && this.Ht ? 1 /* Synced */ : 0 /* Local */ , a = u !== this.Wh;
        return this.Wh = u, 0 !== o.length || a ? {
            snapshot: new Tt(this.query, t.Gh, i, o, t.qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            ea: s
        } : {
            ea: s
    ...
    t.prototype.sa = function(t) {
        ...
        return !this.Bh.has(t) && 
        // The local store doesn't think it's a result, so it shouldn't be in limbo.
        !!this.Gh.has(t) && !this.Gh.get(t).Ge;
    }, 
    /**
    ...
    t.prototype.Zh = function(t) {
        ...
        t && (t.Yt.forEach((function(t) {
            return e.Bh = e.Bh.add(t);
        })), t.Xt.forEach((function(t) {})), t.Jt.forEach((function(t) {
            return e.Bh = e.Bh.delete(t);
        })), this.Ht = t.Ht);
        ...
        // updating many documents.
                var e = this.Qh;
        this.Qh = bt(), this.Gh.forEach((function(e) {
            t.sa(e.key) && (t.Qh = t.Qh.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Qh.has(e) || n.push(new vr(e));
        })), this.Qh.forEach((function(t) {
            e.has(t) || n.push(new yr(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.ia = function(t) {
        this.Bh = t._r, this.Qh = bt();
        var e = this.Kh(t.documents);
        return this.Jh(e, /*updateLimboDocuments=*/ !0);
    }, 
    /**
    ...
    t.prototype.ra = function() {
        return Tt.Bt(this.query, this.Gh, this.qt, 0 /* Local */ === this.Wh);
    }, t;
}(), mr = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        this.ko = t, this.ha = e, this.xo = n, this.aa = r, this.currentUser = i, this.ua = o, 
        this.ca = null, this.la = new M$1((function(t) {
            return gn(t);
        }), vn), this._a = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.da = new at(Q$1.P), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.wa = new Map, this.Ta = new Zn, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ma = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Ea = new Map, this.Ia = Bn.Ps(), this.onlineState = "Unknown" /* Unknown */ , 
        // The primary state is set to `true` or `false` immediately after Firestore
        // startup. In the interim, a client should only be considered primary if
        // `isPrimary` is true.
        this.Ra = void 0;
    }
    return Object.defineProperty(t.prototype, "Aa", {
        get: function() {
            return !0 === this.Ra;
        },
        enumerable: !1,
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Pa("listen()"), (i = this.la.get(t)) ? (
                    ...
                    e = i.targetId, this.aa.Nh(e), r = i.view.ra(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.ko.rr(ln(t)) ];

                  case 2:
                    return o = n.sent(), s = this.aa.Nh(o.targetId), e = o.targetId, [ 4 /*yield*/ , this.Va(t, e, "current" === s) ];

                  case 3:
                    r = n.sent(), this.Aa && this.ha.listen(o), n.label = 4;
     ...
     * snapshot.
     */
    t.prototype.Va = function(t, r, i) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, o, s, u, a, c;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.ko.cr(t, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return e = n.sent(), o = new gr(t, e._r), s = o.Kh(e.documents), u = Dt.Kt(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Jh(s, 
                    /* updateLimboDocuments= */ this.Aa, u), this.pa(r, a.ea), c = new mr(t, r, o), 
                    [ 2 /*return*/ , (this.la.set(t, c), this._a.has(r) ? this._a.get(r).push(t) : this._a.set(r, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.Pa("unlisten()"), e = this.la.get(t), (r = this._a.get(e.targetId)).length > 1 ? [ 2 /*return*/ , (this._a.set(e.targetId, r.filter((function(e) {
                        return !vn(e, t);
                    }))), void this.la.delete(t)) ] : this.Aa ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.aa.xh(e.targetId), this.aa.Mh(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.ko.ur(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.aa.Oh(e.targetId), i.ha.ah(e.targetId), i.ya(e.targetId);
                    })).catch(Jn) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.ya(e.targetId), [ 4 /*yield*/ , this.ko.ur(e.targetId, 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Pa("write()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.ko.bi(t) ];

                  case 2:
                    return e = n.sent(), this.aa.Fh(e.batchId), this.ga(e.batchId, r), [ 4 /*yield*/ , this.va(e.Ci) ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.ha.sh() ];

                  case 4:
                    return n.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = n.sent(), o = Hn(i, "Failed to persist write"), r.reject(o), [ 3 /*break*/ , 6 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Pa("applyRemoteEvent()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Ui(t) ];
                  ...
                  case 2:
                    ...
                    t.Wt.forEach((function(t, e) {
                        ...
                        D$1(t.Yt.size + t.Xt.size + t.Jt.size <= 1), t.Yt.size > 0 ? n.oa = !0 : t.Xt.size > 0 ? D$1(n.oa) : t.Jt.size > 0 && (D$1(n.oa), 
                        n.oa = !1));
                    })), [ 4 /*yield*/ , this.va(e, t) ];
        ...
        // SharedClientState.
        if (this.Aa && 0 /* RemoteStore */ === e || !this.Aa && 1 /* SharedClientState */ === e) {
            this.Pa("applyOnlineStateChange()");
            var n = [];
            this.la.forEach((function(e, r) {
                var i = r.view.na(t);
                i.snapshot && n.push(i.snapshot);
            })), this.ca.ba(t), this.ca.lo(n), this.onlineState = t, this.Aa && this.aa.Uh(t);
        }
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Pa("rejectListens()"), 
                    // PORTING NOTE: Multi-tab only.
                    this.aa.kh(t, "rejected", r), e = this.wa.get(t), (i = e && e.key) ? (o = (o = new at(Q$1.P)).nt(i, new on(i, j.min())), 
                    s = bt().add(i), u = new _t(j.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new ft(O$1), o, s), [ 4 /*yield*/ , this.Ui(u) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 1:
                    ...
                    this.da = this.da.remove(i), this.wa.delete(t), this.Sa(), [ 3 /*break*/ , 4 ];

                  case 2:
                    return [ 4 /*yield*/ , this.ko.ur(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.ya(t, r);
                    })).catch(Jn) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Pa("applySuccessfulWrite()"), e = t.batch.batchId, n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Di(t) ];
                  ...
                  case 2:
                    ...
                    this.Ca(e, /*error=*/ null), this.Da(e), this.aa.$h(e, "acknowledged"), [ 4 /*yield*/ , this.va(r) ];
    ...
    }, t.prototype.ph = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Pa("rejectFailedWrite()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.xi(t) ];
                  ...
                  case 2:
                    ...
                    // listen events.
                    this.Ca(t, r), this.Da(t), this.aa.$h(t, "rejected", r), [ 4 /*yield*/ , this.va(e) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.ha.Wo() || I$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.ko.qi() ];

                  case 2:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Ea.get(e) || []).push(t), 
                    this.Ea.set(e, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = n.sent(), o = Hn(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    t.prototype.Da = function(t) {
        (this.Ea.get(t) || []).forEach((function(t) {
            t.resolve();
        })), this.Ea.delete(t);
    }, 
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.$a = function(t) {
        this.Ea.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new x$1(F$1.CANCELLED, t));
            }));
        })), this.Ea.clear();
    }, t.prototype.ga = function(t, e) {
        var n = this.ma[this.currentUser.Sr()];
        n || (n = new at(O$1)), n = n.nt(t, e), this.ma[this.currentUser.Sr()] = n;
    }, 
    /**
    ...
    t.prototype.Ca = function(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (n) {
            var r = n.get(t);
            r && (e ? r.reject(e) : r.resolve(), n = n.remove(t)), this.ma[this.currentUser.Sr()] = n;
        }
    }, t.prototype.ya = function(t, e) {
        var n = this;
        void 0 === e && (e = null), this.aa.xh(t);
        for (var r = 0, i = this._a.get(t); r < i.length; r++) {
            var o = i[r];
            this.la.delete(o), e && this.ca.Na(o, e);
        }
        this._a.delete(t), this.Aa && this.Ta.Vr(t).forEach((function(t) {
            n.Ta.gr(t) || 
        ...
        var e = this.da.get(t);
        null !== e && (this.ha.ah(e), this.da = this.da.remove(t), this.wa.delete(e), this.Sa());
    }, t.prototype.pa = function(t, e) {
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof yr ? (this.Ta.tr(i.key, t), this.xa(i)) : i instanceof vr ? (I$1("SyncEngine", "Document no longer in limbo: " + i.key), 
            this.Ta.er(i.key, t), this.Ta.gr(i.key) || 
            // We removed the last reference for this key
            this.ka(i.key)) : _();
        }
    }, t.prototype.xa = function(t) {
        var e = t.key;
        this.da.get(e) || (I$1("SyncEngine", "New document in limbo: " + e), this.fa.push(e), 
        this.Sa());
    }, 
    /**
    ...
    t.prototype.Sa = function() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            var t = this.fa.shift(), e = this.Ia.next();
            this.wa.set(e, new wr(t)), this.da = this.da.nt(t, e), this.ha.listen(new it(ln(cn(t.path)), e, 2 /* LimboResolution */ , Fn.ns));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.Oa = function() {
        return this.fa;
    }, t.prototype.va = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o, s = this;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.la.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            var e = u.view.Kh(t);
                            return e.Xh ? s.ko.cr(u.query, /* usePreviousResults= */ !1).then((function(t) {
                                var n = t.documents;
                            ...
                            var n = r && r.Wt.get(u.targetId), o = u.view.Jh(t, 
                            /* updateLimboDocuments= */ s.Aa, n);
                            if (s.pa(u.targetId, o.ea), o.snapshot) {
                                s.Aa && s.aa.kh(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), e.push(o.snapshot);
                                var a = Mn.Xn(u.targetId, o.snapshot);
                                i.push(a);
                            }
                        })));
                  ...
                  case 1:
                    return n.sent(), this.ca.lo(e), [ 4 /*yield*/ , this.ko.Zi(i) ];
    ...
    }, t.prototype.Pa = function(t) {}, t.prototype.yh = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (I$1("SyncEngine", "User change. New user:", t.Sr()), 
                    [ 4 /*yield*/ , this.ko.Vi(t) ]);

                  case 1:
                    return e = n.sent(), this.currentUser = t, 
                    // Fails tasks waiting for pending writes requested by previous user.
                    this.$a("'waitForPendingWrites' promise is rejected due to a user change."), 
                    // TODO(b/114226417): Consider calling this only in the primary tab.
                    this.aa.Vi(t, e.gi, e.vi), [ 4 /*yield*/ , this.va(e.yi) ];
        ...
        var e = this.wa.get(t);
        if (e && e.oa) return bt().add(e.key);
        var n = bt(), r = this._a.get(t);
        if (!r) return n;
        for (var i = 0, o = r; i < o.length; i++) {
            var s = o[i], u = this.la.get(s);
            n = n.Dt(u.view.zh);
        }
        return n;
    }, t;
}(), Er = function() {
    this.qa = void 0, this.listeners = [];
}, Ir = /** @class */ function() {
    function t(t) {
        this.lh = t, this.Ma = new M$1((function(t) {
            return gn(t);
        }), vn), this.onlineState = "Unknown" /* Unknown */ , this.Ua = new Set, this.lh.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.Ma.get(e)) || (r = !0, i = new Er), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.lh.listen(e) ];

                  case 2:
                    return o.qa = n.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = n.sent(), u = Hn(s, "Initialization of query '" + mn(t.query) + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.Ma.set(e, i), i.listeners.push(t), 
                    // Run global snapshot listeners if a consistent snapshot has been emitted.
                    t.na(this.onlineState), i.qa && t.Ba(i.qa) && this.Wa(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.ah = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, r, i, o;
            return __generator(this, (function(n) {
                return e = t.query, r = !1, (i = this.Ma.get(e)) && (o = i.listeners.indexOf(t)) >= 0 && (i.listeners.splice(o, 1), 
                r = 0 === i.listeners.length), r ? [ 2 /*return*/ , (this.Ma.delete(e), this.lh.ah(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.lo = function(t) {
        for (var e = !1, n = 0, r = t; n < r.length; n++) {
            var i = r[n], o = i.query, s = this.Ma.get(o);
            if (s) {
    ...
    function t(t, e, n) {
        ...
        /**
             ...
             */
        this.za = !1, this.Ka = null, this.onlineState = "Unknown" /* Unknown */ , this.options = n || {}
        /**
    ...
    return t.prototype.Ba = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Tt(t.query, t.docs, t.Ot, e, t.qt, t.fromCache, t.Mt, 
            /* excludesMetadataChanges= */ !0);
        }
        var o = !1;
        return this.za ? this.Ha(t) && (this.Ga.next(t), o = !0) : this.Ya(t, this.onlineState) && (this.Xa(t), 
        o = !0), this.Ka = t, o;
    }, t.prototype.onError = function(t) {
        this.Ga.error(t);
    }, 
    /** Returns whether a snapshot was raised. */ t.prototype.na = function(t) {
        this.onlineState = t;
        var e = !1;
        return this.Ka && !this.za && this.Ya(this.Ka, t) && (this.Xa(this.Ka), e = !0), 
        e;
    }, t.prototype.Ya = function(t, e) {
        ...
        var e = this.Ka && this.Ka.hasPendingWrites !== t.hasPendingWrites;
        return !(!t.Mt && !e) && !0 === this.options.includeMetadataChanges;
        // Generally we should have hit one of the cases above, but it's possible
        // to get here if there were only metadata docChanges and they got
        // stripped out.
        }, t.prototype.Xa = function(t) {
        t = Tt.Bt(t.query, t.docs, t.qt, t.fromCache), this.za = !0, this.Ga.next(t);
    }, t;
}(), Ar = /** @class */ function() {
    function t() {}
    return t.prototype.Pi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.on() || n.isEqual(j.min()) ? this.tu(t, e) : this.Za.qn(t, r).next((function(o) {
            var u = i.eu(e, o);
            return (e.hn() || e.an()) && i.Xh(e.en, u, r, n) ? i.tu(t, e) : (E$1() <= LogLevel.DEBUG && I$1("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), mn(e)), 
            i.Za.Bn(t, e, n).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.eu = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof rn && wn(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
     ...
     */
    t.prototype.Xh = function(t, e, n, r) {
        ...
        return E$1() <= LogLevel.DEBUG && I$1("IndexFreeQueryEngine", "Using full collection scan to execute query:", mn(e)), 
        this.Za.Bn(t, e, j.min());
    }, t;
}(), Tr = /** @class */ function() {
    function t(t, e) {
        this.$n = t, this.Yi = e, 
        ...
        this.su = new ft(tr.mr);
    }
    return t.prototype.iu = function(t) {
        return qn.resolve(0 === this.Fn.length);
    }, t.prototype.Si = function(t, e, n, r) {
        var i = this.nu;
        this.nu++, this.Fn.length > 0 && this.Fn[this.Fn.length - 1];
        var o = new Un(i, e, n, r);
        this.Fn.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.su = this.su.add(new tr(a.key, i)), this.$n.Is(t, a.key.path.g());
        }
        return qn.resolve(o);
        ...
        // start of the queue.
                return qn.resolve(this.Fn.length > i ? this.Fn[i] : null);
    }, t.prototype.qi = function() {
        return qn.resolve(0 === this.Fn.length ? -1 : this.nu - 1);
    }, t.prototype.pi = function(t) {
        return qn.resolve(this.Fn.slice());
    }, t.prototype.kn = function(t, e) {
        var n = this, r = new tr(e, 0), i = new tr(e, Number.POSITIVE_INFINITY), o = [];
        return this.su.bt([ r, i ], (function(t) {
            var e = n.ru(t.vr);
            o.push(e);
        })), qn.resolve(o);
    }, t.prototype.Un = function(t, e) {
        var n = this, r = new ft(O$1);
        return e.forEach((function(t) {
            var e = new tr(t, 0), i = new tr(t, Number.POSITIVE_INFINITY);
        ...
        // because it precedes all other segments in an ordered traversal.
                Q$1.W(i) || (i = i.child(""));
        var o = new tr(new Q$1(i), 0), s = new ft(O$1);
        ...
        var n = this;
        D$1(0 === this.au(e.batchId, "removed")), this.Fn.shift();
        var r = this.su;
        return qn.forEach(e.mutations, (function(i) {
            var o = new tr(i.key, e.batchId);
        ...
        var n = new tr(e, 0), r = this.su.Ct(n);
        return qn.resolve(e.isEqual(r && r.key));
    }, t.prototype.ki = function(t) {
        return this.Fn.length, qn.resolve();
    }, 
    /**
    ...
    t.prototype.ou = function(t) {
        return 0 === this.Fn.length ? 0 : t - this.Fn[0].batchId;
    ...
    t.prototype.ru = function(t) {
        var e = this.ou(t);
        return e < 0 || e >= this.Fn.length ? null : this.Fn[e];
    }, t;
}(), _r = /** @class */ function() {
    /**
    ...
    t.prototype.zi = function(t) {
        ...
        for (var r = gt(), i = new Q$1(e.path.child("")), o = this.docs.ut(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.wt(); ) {
            var s = o.dt(), u = s.key, a = s.value, c = a._u, h = a.readTime;
            if (!e.path.C(u.path)) break;
            h.o(n) <= 0 || c instanceof rn && wn(e, c) && (r = r.nt(c.key, c));
        }
        return qn.resolve(r);
 ...
 */
_r.du = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Au = t, n;
    }
    return __extends(n, e), n.prototype.Jh = function(t) {
        var e = this, n = [];
        return this.Ci.forEach((function(r, i) {
            i ? n.push(e.Au.Ki(t, i, e.readTime)) : e.Au.zi(r);
        })), qn.Sn(n);
    }, n.prototype.Iu = function(t, e) {
        return this.Au.Ln(t, e);
    ...
    t.prototype.apply = function(t) {
        return this.Eu(), this.Tu = !0, this.Jh(t);
    }, 
...
var Dr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.pu = new Zn, this.targetCount = 0, this.yu = Bn.As();
    }
    return t.prototype.ge = function(t, e) {
        ...
        return this.highestTargetId = this.yu.next(), qn.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.yu = new Bn(e), this.highestTargetId = e), t.sequenceNumber > this.Vu && (this.Vu = t.sequenceNumber);
        ...
        return this.Pu.delete(e.target), this.pu.Vr(e.targetId), this.targetCount -= 1, 
        qn.resolve();
        ...
        return this.pu.Rr(e, n), qn.resolve();
        ...
        return this.pu.Vr(e), qn.resolve();
    }, t.prototype.lr = function(t, e) {
        var n = this.pu.yr(e);
        return qn.resolve(n);
    }, t.prototype.gr = function(t, e) {
        return qn.resolve(this.pu.gr(e));
    }, t;
}(), Vr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Fu = {}, this.$u = new Fn(0), this.Nu = !1, this.Nu = !0, this.Yi = t(this), 
        this.Ei = new Dr(this), this.$n = new jn, this.Dn = new _r(this.$n, (function(t) {
            return e.Yi.ku(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        return this.Nu = !1, Promise.resolve();
        ...
        var e = this.Fu[t.Sr()];
        return e || (e = new Tr(this.$n, this.Yi), this.Fu[t.Sr()] = e), e;
        ...
        var r = this;
        I$1("MemoryPersistence", "Starting transaction:", t);
        var i = new kr(this.$u.next());
        return this.Yi.qu(), n(i).next((function(t) {
            return r.Yi.Mu(i).next((function() {
                return t;
            }));
        })).vn().then((function(t) {
            return i.Uu(), t;
        ...
        return qn.Cn(Object.values(this.Fu).map((function(n) {
            return function() {
                return n.gr(t, e);
            };
        })));
    ...
    return t.zu = function(e) {
        return new t(e);
    }, Object.defineProperty(t.prototype, "Ku", {
        get: function() {
        ...
        return this.ju.tr(n, e), this.Ku.delete(n), qn.resolve();
    }, t.prototype.er = function(t, e, n) {
        return this.ju.er(n, e), this.Ku.add(n), qn.resolve();
    }, t.prototype.uu = function(t, e) {
        return this.Ku.add(e), qn.resolve();
        ...
        // Remove newly orphaned documents.
                return qn.forEach(this.Ku, (function(r) {
     ...
     * HTTP).
     */
    return __extends(n, e), n.prototype.uc = function(t, e, n, r) {
                ...
                try {
                    switch (s.getLastErrorCode()) {
                      case esm_2.NO_ERROR:
                        ...
                        I$1("Connection", "XHR received:", JSON.stringify(e)), i(e);
                        break;

                      case esm_2.TIMEOUT:
                        I$1("Connection", 'RPC "' + t + '" timed out'), o(new x$1(F$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case esm_2.HTTP_ERROR:
                        var n = s.getStatus();
                        if (I$1("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new x$1(u, r.message));
                            } else o(new x$1(F$1.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new x$1(F$1.UNAVAILABLE, "Connection failed."));
                        break;
                    ...
                    I$1("Connection", 'RPC "' + t + '" completed.');
                }
            }));
        ...
        var n = [ this.rc, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = esm_1(), i = {
        ...
        var o = n.join("");
        I$1("Connection", "Creating WebChannel: " + o, i);
        var s = r.createWebChannel(o, i), p = !1, d = !1, y = new Or({
            Yu: function(t) {
                d ? I$1("Connection", "Not sending because WebChannel is closed:", t) : (p || (I$1("Connection", "Opening WebChannel transport."), 
                s.open(), p = !0), I$1("Connection", "WebChannel sending:", t), s.send(t));
            },
            Xu: function() {
                return s.close();
            }
        ...
        return m(esm_4.EventType.OPEN, (function() {
            d || I$1("Connection", "WebChannel transport opened.");
        })), m(esm_4.EventType.CLOSE, (function() {
            d || (d = !0, I$1("Connection", "WebChannel transport closed"), y.nc());
        })), m(esm_4.EventType.ERROR, (function(t) {
            d || (d = !0, A$1("Connection", "WebChannel transport errored:", t), y.nc(new x$1(F$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    I$1("Connection", "WebChannel received error:", i);
                    ...
                    d = !0, y.nc(new x$1(u, a)), s.close();
                } else I$1("Connection", "WebChannel received:", n), y.sc(n);
            }
        })), setTimeout((function() {
    ...
    return t.prototype.Po = function(t, e, n, r) {
        var i = this.hc(t, e);
        I$1("RestConnection", "Sending: ", i, n);
        var o = {};
        return this.ac(o, r), this.uc(t, i, o, n).then((function(t) {
            return I$1("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw A$1("RestConnection", t + " failed with error: ", e, "url: ", i, "request:", n), 
            e;
        }));
    ...
    return t.prototype.Bo = function(t) {
        ...
        I$1("ConnectivityMonitor", "Network connectivity changed: AVAILABLE");
        for (var t = 0, e = this.dc; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    }, t.prototype.fc = function() {
        I$1("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (var t = 0, e = this.dc; t < e.length; t++) {
            (0, e[t])(1 /* UNAVAILABLE */);
        }
    }, 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Cr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Mr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.aa = this.mc(t), this.persistence = this.Ec(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.Ic = this.Rc(t), this.ko = this.Ac(t), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new Ar, r = t.Pc, new Xn(e, n, r);
        var e, n, r;
    }, t.prototype.Ec = function(t) {
        if (t.pc.Vc) throw new x$1(F$1.FAILED_PRECONDITION, Cr);
        return new Vr(Rr.zu);
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.Ic && this.Ic.stop(), [ 4 /*yield*/ , this.aa.oh() ];

                  case 1:
                    return t.sent(), [ 4 /*yield*/ , this.persistence.oh() ];
        ...
        throw new x$1(F$1.FAILED_PRECONDITION, Cr);
    }, t;
}(), Fr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ko ? [ 2 /*return*/ ] : (this.ko = t.ko, this.aa = t.aa, this.xo = this.yc(r), 
                    [ 4 /*yield*/ , this.gc(r) ]);

                  case 1:
                    return e = n.sent(), this.xo.start(e), this.ha = this.vc(r), this.lh = this.bc(r), 
                    this.Sc = this.Cc(r), this.aa.yo = function(t) {
                        return i.lh.na(t, 1 /* SharedClientState */);
                    }, this.ha.lh = this.lh, [ 4 /*yield*/ , this.ha.start() ];

                  case 2:
                    return n.sent(), [ 4 /*yield*/ , this.ha.gh(this.lh.Aa) ];
        ...
        return e = t.ic, Promise.resolve(new Lr(e));
        var e;
        /** Return the Platform-specific connectivity monitor. */    }, t.prototype.Cc = function(t) {
        return new Ir(this.lh);
        ...
        var e = this;
        return new lr(this.ko, this.xo, t.Vs, (function(t) {
            return e.lh.na(t, 0 /* RemoteStore */);
        }), Ur.Tc() ? new Ur : new Sr);
    }, t.prototype.bc = function(t) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new br(t, e, n, r, i, o);
            return s && (u.Ra = !0), u;
        }(this.ko, this.ha, this.xo, this.aa, t.Pc, t.ua, !t.pc.Vc || !t.pc.synchronizeTabs);
    }, t.prototype.terminate = function() {
        return this.ha.oh();
    }, t;
}();
...
var Gr = /** @class */ function() {
    ...
    return t.prototype.next = function(t) {
        this.observer.next && this.Dc(this.observer.next, t);
    }, t.prototype.error = function(t) {
        this.observer.error ? this.Dc(this.observer.error, t) : console.error("Uncaught Error in snapshot listener:", t);
    }, t.prototype.Fc = function() {
        this.muted = !0;
 ...
 */ function jr(t, e) {
    if (0 !== e.length) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + si(e.length, "argument") + ".");
}
 ...
 */ function zr(t, e, n) {
    if (e.length !== n) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires " + si(n, "argument") + ", but was called with " + si(e.length, "argument") + ".");
}
 ...
 */ function Br(t, e, n) {
    if (e.length < n) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + si(n, "argument") + ", but was called with " + si(e.length, "argument") + ".");
}
 ...
 */ function Kr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + si(e.length, "argument") + ".");
}
...
function $r(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = ti(r);
        throw new x$1(F$1.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function Xr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid value " + ti(r) + " provided to function " + t + "() for its " + oi(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function Jr(t, e, n, r) {
    if (!("object" === e ? Zr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = ti(r);
        throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
/** Returns a string describing the type / value of the provided input. */ function ti(t) {
...
function ei(t, e, n) {
    if (void 0 === n) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + oi(e) + " argument, but it was undefined.");
}
 ...
 */ function ni(t, e, n) {
    q$1(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new x$1(F$1.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function ri(t, e, n, r) {
    var i = ti(r);
    return new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + oi(n) + " argument to be a " + e + ", but it was: " + i);
}

function ii(t, e, n) {
    if (n <= 0) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + oi(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function oi(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function ui() {
    if ("undefined" == typeof Uint8Array) throw new x$1(F$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function ai() {
    if ("undefined" == typeof atob) throw new x$1(F$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var ci = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        zr("Blob.fromBase64String", arguments, 1), Wr("Blob.fromBase64String", "string", 1, e), 
        ai();
        try {
            return new t(et.fromBase64String(e));
        } catch (e) {
            throw new x$1(F$1.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
        if (zr("Blob.fromUint8Array", arguments, 1), ui(), !(e instanceof Uint8Array)) throw ri("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(et.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return zr("Blob.toBase64", arguments, 0), ai(), this.$c.toBase64();
    }, t.prototype.toUint8Array = function() {
        return zr("Blob.toUint8Array", arguments, 0), ui(), this.$c.toUint8Array();
    }, t.prototype.toString = function() {
        return "Blob(base64: " + this.toBase64() + ")";
    }, t.prototype.isEqual = function(t) {
        return this.$c.isEqual(t.$c);
    }, t;
}(), hi = function(t) {
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new x$1(F$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + si(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Wr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Nc = new W$1(t);
}, fi = /** @class */ function(e) {
    /**
...
}(hi), li = new RegExp("[~\\*/\\[\\]]"), pi = function() {
    /** A pointer to the implementing class. */
    this.kc = this;
}, di = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).xc = t, n;
    }
    return __extends(n, e), n.prototype.Lc = function(t) {
        if (2 /* MergeSet */ !== t.Oc) throw 1 /* Update */ === t.Oc ? t.qc(this.xc + "() can only appear at the top level of your update data") : t.qc(this.xc + "() cannot be used with set() unless you pass {merge:true}");
...
var vi = /** @class */ function(e) {
...
}(pi), gi = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).xc = t, r.Bc = n, r;
    }
    return __extends(n, e), n.prototype.Lc = function(t) {
        var e = yi(this, t, 
...
}(pi), wi = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).xc = t, r.Wc = n, r;
    }
    return __extends(n, e), n.prototype.Lc = function(t) {
        var e = new Oe(t.serializer, ie(t.serializer, this.Wc));
        return new Se(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(pi), bi = /** @class */ function(e) {
    function n() {
        return e.call(this) || this;
    }
    return __extends(n, e), n.delete = function() {
        return jr("FieldValue.delete", arguments), new Ei(new di("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return jr("FieldValue.serverTimestamp", arguments), new Ei(new vi("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Br("FieldValue.arrayUnion", arguments, 1), new Ei(new gi("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Br("FieldValue.arrayRemove", arguments, 1), new Ei(new mi("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return Wr("FieldValue.increment", "number", 1, t), zr("FieldValue.increment", arguments, 1), 
        new Ei(new wi("FieldValue.increment", t));
    }, n;
}(pi), Ei = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).kc = t, n.xc = t.xc, n;
    }
    return __extends(n, e), n.prototype.Lc = function(t) {
        return this.kc.Lc(t);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.kc.isEqual(t.kc);
    }, n;
}(bi), Ii = /** @class */ function() {
    function t(t, e) {
        if (zr("GeoPoint", arguments, 2), Wr("GeoPoint", "number", 1, t), Wr("GeoPoint", "number", 2, e), 
        !isFinite(t) || t < -90 || t > 90) throw new x$1(F$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new x$1(F$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Qc = t, this.jc = e;
    }
    return Object.defineProperty(t.prototype, "latitude", {
        ...
        return this.Qc === t.Qc && this.jc === t.jc;
    }, 
    /**
     ...
     */
    t.prototype.T = function(t) {
        return O$1(this.Qc, t.Qc) || O$1(this.jc, t.jc);
    }, t;
}(), Ni = /^__.*__$/, Ai = function(t, e, n) {
    this.Gc = t, this.zc = e, this.Kc = n;
}, Ti = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.qe = e, this.fieldTransforms = n;
    }
    return t.prototype.Hc = function(t, e) {
        var n = [];
        return null !== this.qe ? n.push(new We(t, this.data, this.qe, e)) : n.push(new Ke(t, this.data, e)), 
...
/** A "context" object passed around while parsing user data. */ var Vi = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Yc(), this.fieldTransforms = i || [], this.qe = o || [];
    }
    return Object.defineProperty(t.prototype, "path", {
        ...
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "Oc", {
        get: function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Xc = function(e) {
        ...
        return xi(t, this.settings.methodName, this.settings.nl || !1, this.path, this.settings.Mc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.Zc(this.path.get(t));
    }, t.prototype.Zc = function(t) {
        if (0 === t.length) throw this.qc("Document fields must not be empty");
        if (Di(this.Oc) && Ni.test(t)) throw this.qc('Document fields cannot begin and end with "__"');
    }, t;
}(), ki = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.sl = function(t, e, n, r) {
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function Ri(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.sl(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Ci("Data must be an object, but it was:", s, r);
    var u, a, c = Si(r, s);
    if (o.merge) u = new Ue(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var p = l[f], d = void 0;
            if (p instanceof hi) d = p.Nc; else {
                if ("string" != typeof p) throw _();
                d = Fi(e, p, n);
            }
            if (!s.contains(d)) throw new x$1(F$1.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Gi(h, d) || h.push(d);
        }
    ...
    return new Ti(new Ze(c), u, a);
}

/** Parse update data from an update() call. */ function Oi(t, e, n, r) {
    var i = t.sl(1 /* Update */ , e, n);
    Ci("Data must be an object, but it was:", i, r);
    var o = [], s = new tn;
    q$1(r, (function(t, r) {
        var u = Fi(e, t, n), a = i.tl(u);
        if (r instanceof pi && r.kc instanceof di) 
    ...
    var u = new Ue(o);
    return new _i(s.ze(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Pi(t, e, n, r, i, o) {
    var s = t.sl(1 /* Update */ , e, n), u = [ Mi(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) u.push(Mi(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new tn, l = u.length - 1; l >= 0; --l) if (!Gi(h, u[l])) {
        var p = u[l], d = a[l], y = s.tl(p);
        if (d instanceof pi && d.kc instanceof di) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var v = Ui(d, y);
    ...
    var g = new Ue(h);
    return new _i(f.ze(), g, s.fieldTransforms);
}
 ...
 */ function Li(t, e, n, r) {
    return void 0 === r && (r = !1), Ui(n, t.sl(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ui(t, e) {
    if (qi(t)) return Ci("Unsupported field value:", e, t), Si(t, e);
    if (t instanceof pi) 
    ...
    return function(t, e) {
        ...
        if (!Di(e.Oc)) throw e.qc(t.xc + "() can only be used with update() and set()");
        if (!e.path) throw e.qc(t.xc + "() is not currently supported inside arrays");
        var n = t.Lc(e);
    ...
    e.path && e.qe.push(e.path), t instanceof Array) {
        ...
        if (e.settings.Uc && 4 /* ArrayArgument */ !== e.Oc) throw e.qc("Nested arrays are not supported");
        return function(t, e) {
    ...
    return function(t, e) {
        ...
        if (t instanceof G$1) {
            ...
            var r = new G$1(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: oe(e.serializer, r)
            };
        }
        ...
        if (t instanceof Ai) {
            ...
            return {
                referenceValue: ce(t.Gc || e.s, t.zc.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.qc("Unsupported field value: " + ti(t));
    }(t, e);
}
...
function Si(t, e) {
    ...
    e.path && e.path.length > 0 && e.qe.push(e.path) : q$1(t, (function(t, r) {
        var i = Ui(r, e.Jc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function qi(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof G$1 || t instanceof Ii || t instanceof ci || t instanceof Ai || t instanceof pi);
}
 ...
 */ function Mi(t, e, n) {
    if (e instanceof hi) return e.Nc;
    if ("string" == typeof e) return Fi(t, e);
    throw xi("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function Fi(t, e, n) {
    try {
        return function(t) {
            if (t.search(li) >= 0) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (fi.bind.apply(fi, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new x$1(F$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).Nc;
    } catch (e) {
        throw xi((i = e) instanceof Error ? i.message : i.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
...
function xi(t, e, n, r, i) {
    ...
    a += ")"), new x$1(F$1.INVALID_ARGUMENT, (u += ". ") + t + a);
}
 ...
 */ var ji = /** @class */ function() {
    function t(t) {
        ...
        this.il = new Map, this.mutations = [], this.rl = !1, 
        /**
    ...
    return t.prototype.al = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ul(), this.mutations.length > 0) throw new x$1(F$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = V$1(t), i = pe(e.serializer) + "/documents", o = {
                                    ...
                                    return s = n.sent(), u = new Map, s.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                D$1(!!e.found), e.found.name, e.found.updateTime;
                                                var n = fe(t, e.found.name), r = ae(e.found.updateTime), i = new Ze({
                                                    mapValue: {
                                                ...
                                                D$1(!!e.missing), D$1(!!e.readTime);
                                                var n = fe(t, e.missing), r = ae(e.readTime);
                                                return new on(n, r);
                                            }(t, e) : _();
                                        }(e.serializer, t);
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof on || t instanceof rn ? i.cl(t) : _();
                    })), r) ];
                }
            }));
        }));
    }, t.prototype.set = function(t, e) {
        this.write(e.Hc(t, this.Be(t))), this.hl.add(t);
    }, t.prototype.update = function(t, e) {
        try {
            this.write(e.Hc(t, this.ll(t)));
        } catch (t) {
            this.ol = t;
        }
        this.hl.add(t);
    }, t.prototype.delete = function(t) {
        this.write([ new Xe(t, this.Be(t)) ]), this.hl.add(t);
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.ul(), this.ol) throw this.ol;
                    return t = this.il, 
                    ...
                    t.forEach((function(t, e) {
                        var n = new Q$1(B.N(e));
                        r.mutations.push(new Je(n, r.Be(n)));
                    ...
                    }(this.xo, this.mutations) ];

                  case 1:
                    // For each mutation, note that the doc was written.
                    return i.sent(), this.rl = !0, [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        if (t instanceof rn) e = t.version; else {
            if (!(t instanceof on)) throw _();
            // For deleted docs, we must use baseVersion 0 when we overwrite them.
                        e = j.min();
        }
        var n = this.il.get(t.key.toString());
        if (n) {
            if (!e.isEqual(n)) 
            // This transaction will fail no matter what.
            throw new x$1(F$1.ABORTED, "Document version changed between two reads.");
        } else this.il.set(t.key.toString(), e);
    }, 
    /**
     ...
     */
    t.prototype.Be = function(t) {
        var e = this.il.get(t.toString());
        return !this.hl.has(t) && e ? Ce.updateTime(e) : Ce.je();
    }, 
    /**
    ...
    t.prototype.ll = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new x$1(F$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
        ...
        this.ul(), this.mutations = this.mutations.concat(t);
    }, t.prototype.ul = function() {}, t;
}(), zi = /** @class */ function() {
    function t(t, e, n, r) {
        this.Vs = t, this.xo = e, this.updateFunction = n, this.gs = r, this._l = 5, this.Os = new Gn(this.Vs, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Os.fs((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, r = this;
                return __generator(this, (function(n) {
                    return t = new ji(this.xo), (e = this.dl(t)) && e.then((function(e) {
                        r.Vs.Cs((function() {
        ...
        try {
            ...
            return !Y$1(e) && e.catch && e.then ? e : (this.gs.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
            // Do not retry errors thrown by user provided updateFunction.
            return this.gs.reject(t), null;
        }
    }, t.prototype.wl = function(t) {
        var e = this;
        this._l > 0 && this.Tl(t) ? (this._l -= 1, this.Vs.Cs((function() {
     ...
     */
    e) {
        this.credentials = t, this.Vs = e, this.clientId = R$1.t(), 
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.kr((function(t) {
            if (!s) return s = !0, I$1("FirestoreClient", "Initializing. user=", t.uid), i.Il(e, n, r, t, o).then(i.ml.resolve, i.ml.reject);
            i.Vs.Gs((function() {
                return i.ha.yh(t);
            }));
        })), 
    ...
    /** Enables the network connection and requeues all pending operations. */ t.prototype.enableNetwork = function() {
        var t = this;
        return this.El(), this.Vs.enqueue((function() {
            return t.persistence.Ou(!0), t.ha.enableNetwork();
        }));
    }, 
    /**
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(h) {
                switch (h.label) {
                  ...
                  case 2:
                    return h.sent(), this.persistence = t.persistence, this.aa = t.aa, this.ko = t.ko, 
                    this.Ic = t.Ic, this.xo = r.xo, this.ha = r.ha, this.lh = r.lh, this.Rl = r.Sc, 
    ...
    t.prototype.El = function() {
        if (this.Vs.Ms) throw new x$1(F$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Disables the network connection. Pending operations will not complete. */ t.prototype.disableNetwork = function() {
        var t = this;
        return this.El(), this.Vs.enqueue((function() {
            return t.persistence.Ou(!1), t.ha.disableNetwork();
        }));
    }, t.prototype.terminate = function() {
        var t = this;
        return this.Vs.js((function() {
            return __awaiter(t, void 0, void 0, (function() {
                return __generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        // PORTING NOTE: LocalStore does not need an explicit shutdown on web.
                        return this.Ic && this.Ic.stop(), [ 4 /*yield*/ , this.ha.oh() ];

                      case 1:
                        return t.sent(), [ 4 /*yield*/ , this.aa.oh() ];
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        this.El();
        var e = new xn;
        return this.Vs.Cs((function() {
            return t.lh.Fa(e);
        })), e.promise;
    }, t.prototype.listen = function(t, e, n) {
        var r = this;
        this.El();
        var i = new Gr(n), o = new Nr(t, i, e);
        return this.Vs.Cs((function() {
            return r.Rl.listen(o);
        })), function() {
            i.Fc(), r.Vs.Cs((function() {
                return r.Rl.ah(o);
            }));
        };
                    ...
                    return [ 2 /*return*/ , (r.sent(), function(t, r, i) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(u) {
                                switch (u.label) {
                                  case 0:
                                    return o = new xn, [ 4 /*yield*/ , t.enqueue((function() {
                                        return __awaiter(s, void 0, void 0, (function() {
                                            ...
                                            return __generator(this, (function(n) {
                                                switch (n.label) {
                                                  ...
                                                  case 1:
                                                    return (t = n.sent()) instanceof rn ? o.resolve(t) : t instanceof on ? o.resolve(null) : o.reject(new x$1(F$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];

                                                  case 2:
                                                    return e = n.sent(), s = Hn(e, "Failed to get document '" + i + " from cache"), 
                ...
                switch (e.label) {
                  ...
                  case 1:
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new xn, o = Ki(t, e, cn(n.path), {
                            ...
                            next: function(t) {
                                ...
                                i.reject(new x$1(F$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : e && t.fromCache && r && "server" === r.source ? i.reject(new x$1(F$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                                        ...
                                        return __awaiter(s, void 0, void 0, (function() {
                                            ...
                                            return __generator(this, (function(n) {
                                                switch (n.label) {
                                                  ...
                                                  case 1:
                                                    return t = n.sent(), e = new gr(i, t._r), s = e.Kh(t.documents), u = e.Jh(s, 
                                                    /* updateLimboDocuments= */ !1), o.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                                  case 2:
                                                    return a = n.sent(), c = Hn(a, "Failed to execute query '" + i + " against cache"), 
                    ...
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new xn, o = Ki(t, e, n, {
                            ...
                            next: function(t) {
                                // Remove query first before passing event to user to avoid
                                // user actions affecting the now stale query.
                                o(), t.fromCache && r && "server" === r.source ? i.reject(new x$1(F$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new xn;
        return this.Vs.Cs((function() {
            return new zi(e.Vs, e.xo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var Wi = /** @class */ function() {
    ...
    return t.prototype.Sl = function(t) {
        switch (Mt(t)) {
          ...
          case 6 /* BlobValue */ :
            return new ci(Wt(t.bytesValue));

          case 7 /* RefValue */ :
            return this.Fl(t.referenceValue);

          case 8 /* GeoPointValue */ :
            return this.$l(t.geoPointValue);

          case 9 /* ArrayValue */ :
            return this.Nl(t.arrayValue);
        ...
        return new Ii(Kt(t.latitude), Kt(t.longitude));
        ...
        var e = Bt(t), n = new G$1(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.Fl = function(t) {
        var e = B.N(t);
        D$1(Ee(e));
        var n = new U$1(e.get(1), e.get(3)), r = new Q$1(e.p(5));
        return n.isEqual(this.s) || 
        // TODO(b/64130202): Somehow support foreign references.
        N$1("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.s.projectId + "/" + this.s.database + ") instead."), 
        this.bl(r);
    }, t;
}(), Qi = $n.oi, Yi = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new x$1(F$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Yr("settings", "non-empty string", "host", t.host), this.host = t.host, Hr("settings", "boolean", "ssl", t.ssl), 
        ...
        !0 === t.timestampsInSnapshots ? N$1("The setting 'timestampsInSnapshots: true' is no longer required and should be removed.") : !1 === t.timestampsInSnapshots && N$1("Support for 'timestampsInSnapshots: false' will be removed soon. You must update your code to handle Timestamp objects."), 
        ...
        Hr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = $n.ai; else {
            if (t.cacheSizeBytes !== Qi && t.cacheSizeBytes < $n.hi) throw new x$1(F$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + $n.hi);
    ...
    function t(r, i, o, s) {
        var u = this;
        if (void 0 === o && (o = new Mr), void 0 === s && (s = new Fr), this.xl = o, this.Ll = s, 
        this.Ol = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.ql = new Yn, this.INTERNAL = {
            delete: function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            ...
                            // throws an exception.
                            return this.Ml(), [ 4 /*yield*/ , this.Ul.terminate() ];
            ...
            var a = r;
            this.Ol = a, this.Gc = t.Bl(a), this.Wl = a.name, this.Ql = new ir(i);
        } else {
            var c = r;
            if (!c.projectId) throw new x$1(F$1.INVALID_ARGUMENT, "Must provide projectId");
            this.Gc = new U$1(c.projectId, c.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Wl = "[DEFAULT]", this.Ql = new rr;
        }
        this.jl = new Yi({});
    }
    return Object.defineProperty(t.prototype, "Gl", {
        get: function() {
            ...
            this.zl = new ki(this.Gc, this.jl.ignoreUndefinedProperties)), this.zl;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        zr("Firestore.settings", arguments, 1), Wr("Firestore.settings", "object", 1, t);
        var e = new Yi(t);
        if (this.Ul && !this.jl.isEqual(e)) throw new x$1(F$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
            ...
            switch (t.type) {
              case "gapi":
                ...
                // Make sure this really is a Gapi client.
                                return D$1(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), 
                new sr(e, t.Br || "0");
              ...
              default:
                throw new x$1(F$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        return this.Ml(), this.Ul.enableNetwork();
    }, t.prototype.disableNetwork = function() {
        return this.Ml(), this.Ul.disableNetwork();
    }, t.prototype.enablePersistence = function(t) {
        var e, n;
        if (this.Ul) throw new x$1(F$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        if (t && (void 0 !== t.experimentalTabSynchronization && N$1("The 'experimentalTabSynchronization' setting will be removed. Use 'synchronizeTabs' instead."), 
        r = null !== (n = null !== (e = t.synchronizeTabs) && void 0 !== e ? e : t.experimentalTabSynchronization) && void 0 !== n && n, 
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new x$1(F$1.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t, r = this;
            return __generator(this, (function(i) {
                if (void 0 !== this.Ul && !this.Ul.gl) throw new x$1(F$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new xn, [ 2 /*return*/ , (this.ql.Us((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        var e;
                        return __generator(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.xl.clearPersistence(this.Gc, this.Wl) ];
        ...
        get: function() {
            return this.Ml(), this.Ul.gl;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.waitForPendingWrites = function() {
        return this.Ml(), this.Ul.waitForPendingWrites();
    }, t.prototype.onSnapshotsInSync = function(t) {
        if (this.Ml(), xr(t)) return this.Ul.Qa(t);
        Wr("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return this.Ul.Qa(e);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Hl(new Mr, new Fr, {
            Vc: !1
        }), this.Ul;
    }, t.prototype.Jl = function() {
        return new L$1(this.Gc, this.Wl, this.jl.host, this.jl.ssl, this.jl.forceLongPolling);
    }, t.prototype.Hl = function(t, e, n) {
        var r = this.Jl();
        return this.Ul = new Bi(this.Ql, this.ql), this.Ul.start(r, t, e, n);
    }, t.Bl = function(t) {
        if (e = t.options, !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new x$1(F$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new x$1(F$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new U$1(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Ol) throw new x$1(F$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ol;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return zr("Firestore.collection", arguments, 1), Wr("Firestore.collection", "non-empty string", 1, t), 
        this.Ml(), new ho(B.N(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return zr("Firestore.doc", arguments, 1), Wr("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), Ji.Zl(B.N(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (zr("Firestore.collectionGroup", arguments, 1), Wr("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.Ml(), new ao(function(t) {
            return new an(B.k(), t);
        }(t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return zr("Firestore.runTransaction", arguments, 1), Wr("Firestore.runTransaction", "function", 1, t), 
        this.Ml().transaction((function(n) {
            return t(new $i(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.Ml(), new Xi(this);
        ...
        var e;
        zr("Firestore.setLogLevel", arguments, 1), Xr("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, b.setLogLevel(e);
    }, 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = yo("Transaction.get", t, this.e_);
        return this.n_.al([ n.zc ]).then((function(t) {
            if (!t || 1 !== t.length) return _();
            var r = t[0];
            if (r instanceof on) return new to(e.e_, n.zc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            if (r instanceof rn) return new to(e.e_, n.zc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            throw _();
        }));
        ...
        var r = yo("Transaction.set", t, this.e_);
        n = fo("Transaction.set", n);
        var i = go(r.Kc, e, n), o = Ri(this.e_.Gl, "Transaction.set", r.zc, i, null !== r.Kc, n);
        return this.n_.set(r.zc, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof fi ? (Br("Transaction.update", arguments, 3), 
        r = yo("Transaction.update", t, this.e_), i = Pi(this.e_.Gl, "Transaction.update", r.zc, e, n, o)) : (zr("Transaction.update", arguments, 2), 
        r = yo("Transaction.update", t, this.e_), i = Oi(this.e_.Gl, "Transaction.update", r.zc, e)), 
        this.n_.update(r.zc, i), this;
    }, t.prototype.delete = function(t) {
        zr("Transaction.delete", arguments, 1);
        var e = yo("Transaction.delete", t, this.e_);
        return this.n_.delete(e.zc), this;
    }, t;
}(), Xi = /** @class */ function() {
    function t(t) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = yo("WriteBatch.set", t, this.e_);
        n = fo("WriteBatch.set", n);
        var i = go(r.Kc, e, n), o = Ri(this.e_.Gl, "WriteBatch.set", r.zc, i, null !== r.Kc, n);
        return this.s_ = this.s_.concat(o.Hc(r.zc, Ce.je())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.r_(), "string" == typeof e || e instanceof fi ? (Br("WriteBatch.update", arguments, 3), 
        r = yo("WriteBatch.update", t, this.e_), i = Pi(this.e_.Gl, "WriteBatch.update", r.zc, e, n, o)) : (zr("WriteBatch.update", arguments, 2), 
        r = yo("WriteBatch.update", t, this.e_), i = Oi(this.e_.Gl, "WriteBatch.update", r.zc, e)), 
        this.s_ = this.s_.concat(i.Hc(r.zc, Ce.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        zr("WriteBatch.delete", arguments, 1), this.r_();
        var e = yo("WriteBatch.delete", t, this.e_);
        return this.s_ = this.s_.concat(new Xe(e.zc, Ce.je())), this;
    }, t.prototype.commit = function() {
        return this.r_(), this.i_ = !0, this.s_.length > 0 ? this.e_.Ml().write(this.s_) : Promise.resolve();
    }, t.prototype.r_ = function() {
        if (this.i_) throw new x$1(F$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Ji = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, n.Gc, t, r) || this).zc = t, i.firestore = n, i.Kc = r, 
        i.Ul = i.firestore.Ml(), i;
    }
    return __extends(n, e), n.Zl = function(t, e, r) {
        if (t.length % 2 != 0) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.$() + " has " + t.length);
        return new n(new Q$1(t), e, r);
    }, Object.defineProperty(n.prototype, "id", {
        get: function() {
            return this.zc.path.S();
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(n.prototype, "parent", {
        get: function() {
            return new ho(this.zc.path.g(), this.firestore, this.Kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (zr("DocumentReference.collection", arguments, 1), Wr("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new x$1(F$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = B.N(t);
        return new ho(this.zc.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw ri("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.zc.isEqual(t.zc) && this.Kc === t.Kc;
    }, n.prototype.set = function(t, e) {
        Kr("DocumentReference.set", arguments, 1, 2), e = fo("DocumentReference.set", e);
        var n = go(this.Kc, t, e), r = Ri(this.firestore.Gl, "DocumentReference.set", this.zc, n, null !== this.Kc, e);
        return this.Ul.write(r.Hc(this.zc, Ce.je()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof fi ? (Br("DocumentReference.update", arguments, 2), 
        n = Pi(this.firestore.Gl, "DocumentReference.update", this.zc, t, e, r)) : (zr("DocumentReference.update", arguments, 1), 
        n = Oi(this.firestore.Gl, "DocumentReference.update", this.zc, t)), this.Ul.write(n.Hc(this.zc, Ce.exists(!0)));
    }, n.prototype.delete = function() {
        return zr("DocumentReference.delete", arguments, 0), this.Ul.write([ new Xe(this.zc, Ce.je()) ]);
        ...
        "object" != typeof i[u] || xr(i[u]) || (ni("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        Hr("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++);
        var a = {
        ...
        } else Wr("DocumentReference.onSnapshot", "function", u, i[u]), Qr("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        Qr("DocumentReference.onSnapshot", "function", u + 2, i[u + 2]);
        var h = {
            next: function(t) {
                i[u] && i[u](r.o_(t));
            },
        ...
        return this.Ul.listen(cn(this.zc.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        Kr("DocumentReference.get", arguments, 0, 1), po("DocumentReference.get", t);
        var n = this.firestore.Ml();
        return t && "cache" === t.source ? n.Pl(this.zc).then((function(t) {
            return new to(e.firestore, e.zc, t, 
            /*fromCache=*/ !0, t instanceof rn && t.Ge, e.Kc);
        })) : n.Vl(this.zc, t).then((function(t) {
            return e.o_(t);
        }));
    }, n.prototype.withConverter = function(t) {
        return new n(this.zc, this.firestore, t);
    }, 
    /**
    ...
    n.prototype.o_ = function(t) {
        var e = t.docs.get(this.zc);
        return new to(this.firestore, this.zc, e, t.fromCache, t.hasPendingWrites, this.Kc);
    }, n;
}(Ai), Zi = /** @class */ function() {
    function t(t, e) {
    ...
    function t(t, e, n, r, i, o) {
        this.e_ = t, this.zc = e, this.h_ = n, this.a_ = r, this.u_ = i, this.Kc = o;
    }
    return t.prototype.data = function(t) {
        var e = this;
        if (Kr("DocumentSnapshot.data", arguments, 0, 1), t = lo("DocumentSnapshot.data", t), 
        this.h_) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Kc) {
                var n = new eo(this.e_, this.zc, this.h_, this.a_, this.u_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(n, t);
            }
            return new Wi(this.e_.Gc, this.e_.t_(), t.serverTimestamps || "none", (function(t) {
                return new Ji(t, e.e_, /* converter= */ null);
            })).Sl(this.h_.Ze());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (Kr("DocumentSnapshot.get", arguments, 1, 2), e = lo("DocumentSnapshot.get", e), 
        this.h_) {
            var r = this.h_.data().field(Mi("DocumentSnapshot.get", t, this.zc));
            if (null !== r) return new Wi(this.e_.Gc, this.e_.t_(), e.serverTimestamps || "none", (function(t) {
                return new Ji(t, n.e_, n.Kc);
            })).Sl(r);
        }
        ...
        get: function() {
            return new Ji(this.zc, this.e_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        get: function() {
            return new Zi(this.u_, this.a_);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw ri("isEqual", "DocumentSnapshot", 1, e);
        return this.e_ === e.e_ && this.a_ === e.a_ && this.zc.isEqual(e.zc) && (null === this.h_ ? null === e.h_ : this.h_.isEqual(e.h_)) && this.Kc === e.Kc;
    }, t;
}(), eo = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
...
function no(t, e, n, r, i, o, s) {
    var u;
    if (i.O()) {
        if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
        if ("in" /* IN */ === o) {
            oo(s, o);
    ...
    } else "in" /* IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || oo(s, o), 
    u = Li(n, e, s, "in" /* IN */ === o);
    var l = En.create(i, o, u);
    return function(t, e) {
        ...
        if (e.ln()) {
            var s = t.cn();
            if (null !== s && !s.isEqual(e.field)) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + s.toString() + "' and '" + e.field.toString() + "'");
            var u = t.un();
            null !== u && so(t, e.field, u);
        } else if (o || i) {
            ...
            throw a === e.op ? new x$1(F$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new x$1(F$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + a.toString() + "' filters.");
        }
    }(t, l), l;
}

function ro(t, e, n) {
    if (null !== t.startAt) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
    if (null !== t.endAt) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
    var r = new On(e, n);
    return function(t, e) {
        if (null === t.un()) {
            // This is the first order by. It must match any inequality.
            var n = t.cn();
            null !== n && so(t, n, e.field);
        }
    }(t, r), r
    /**
...
function io(t, e, n) {
    if ("string" == typeof n) {
        if ("" === n) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!hn(e) && -1 !== n.indexOf("/")) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(B.N(n));
        if (!Q$1.W(r)) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Qt(t, new Q$1(r));
    }
    if (n instanceof Ai) return Qt(t, n.zc);
    throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ti(n) + ".");
}
 ...
 * array requirements.
 */ function oo(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
    if (t.indexOf(null) >= 0) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
    if (t.filter((function(t) {
        return Number.isNaN(t);
    })).length > 0) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
}

function so(t, e, n) {
    if (!n.isEqual(e)) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}

function uo(t) {
    if (t.an() && 0 === t.tn.length) throw new x$1(F$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var ao = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        zr("Query.where", arguments, 3), ei("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = Xr("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n), o = Mi("Query.where", e), s = no(this.c_, "Query.where", this.firestore.Gl, this.firestore.Gc, o, i, r);
        return new t(function(t, e) {
            var n = t.filters.concat([ e ]);
            return new an(t.path, t.collectionGroup, t.tn.slice(), n, t.limit, t.en, t.startAt, t.endAt);
        }(this.c_, s), this.firestore, this.Kc);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (Kr("Query.orderBy", arguments, 1, 2), Qr("Query.orderBy", "non-empty string", 2, n), 
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new x$1(F$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        var i = Mi("Query.orderBy", e), o = ro(this.c_, i, r);
        return new t(function(t, e) {
            // TODO(dimond): validate that orderBy does not list the same key twice.
            var n = t.tn.concat([ e ]);
            return new an(t.path, t.collectionGroup, n, t.filters.slice(), t.limit, t.en, t.startAt, t.endAt);
        }(this.c_, o), this.firestore, this.Kc);
    }, t.prototype.limit = function(e) {
        return zr("Query.limit", arguments, 1), Wr("Query.limit", "number", 1, e), ii("Query.limit", 1, e), 
        new t(pn(this.c_, e, "F" /* First */), this.firestore, this.Kc);
    }, t.prototype.limitToLast = function(e) {
        return zr("Query.limitToLast", arguments, 1), Wr("Query.limitToLast", "number", 1, e), 
        ii("Query.limitToLast", 1, e), new t(pn(this.c_, e, "L" /* Last */), this.firestore, this.Kc);
        ...
        /*before=*/ !0);
        return new t(yn(this.c_, i), this.firestore, this.Kc);
        ...
        return this.firestore === e.firestore && vn(this.c_, e.c_) && this.Kc === e.Kc;
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.l_ = function(t, e, n, i) {
        if (ei(t, 1, e), e instanceof to) return zr(t, __spreadArrays([ e ], n), 1), function(t, e, n, r, i) {
            if (!r) throw new x$1(F$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
            ...
            for (var o = [], s = 0, u = fn(t); s < u.length; s++) {
                ...
                if (a.field.O()) o.push(Qt(e, r.key)); else {
                    ...
                    if (St(c)) throw new x$1(F$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.$();
                        throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                    }
                    o.push(c);
                }
            }
            return new Dn(o, i);
        }(this.c_, this.firestore.Gc, t, e.h_, i);
        var o = [ e ].concat(n);
        return function(t, e, n, r, i, o) {
            // Use explicit order by's because it has to match the query the user made
            var s = t.tn;
            if (i.length > s.length) throw new x$1(F$1.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
            for (var u = [], a = 0; a < i.length; a++) {
                var c = i[a];
                if (s[a].field.O()) {
                    if ("string" != typeof c) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                    if (!hn(t) && -1 !== c.indexOf("/")) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(B.N(c));
                    if (!Q$1.W(h)) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new Q$1(h);
                    u.push(Qt(e, f));
                } else {
                    var l = Li(n, r, c);
            ...
            return new Dn(u, o);
        }(this.c_, this.firestore.Gc, this.firestore.Gl, t, o, i);
    }, t.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        Kr("Query.onSnapshot", arguments, 1, 4);
        var s = {}, u = 0;
        if ("object" != typeof i[u] || xr(i[u]) || (ni("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        Hr("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++), xr(i[u])) {
            var a = i[u];
        ...
        } else Wr("Query.onSnapshot", "function", u, i[u]), Qr("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        Qr("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new co(r.firestore, r.c_, t, r.Kc));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return uo(this.c_), this.firestore.Ml().listen(this.c_, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        Kr("Query.get", arguments, 0, 1), po("Query.get", t), uo(this.c_);
        var n = this.firestore.Ml();
        return (t && "cache" === t.source ? n.pl(this.c_) : n.yl(this.c_, t)).then((function(t) {
            return new co(e.firestore, e.c_, t, e.Kc);
        }));
    }, t;
}(), co = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        Kr("QuerySnapshot.forEach", arguments, 1, 2), Wr("QuerySnapshot.forEach", "function", 1, t), 
        this.f_.docs.forEach((function(r) {
            t.call(e, n.T_(r, n.metadata.fromCache, n.f_.qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new ao(this.__, this.e_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (ni("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Hr("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.f_.Ut) throw new x$1(F$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.e_ === e.e_ && vn(this.__, e.__) && this.f_.isEqual(e.f_) && this.Kc === e.Kc;
    }, t.prototype.T_ = function(t, e, n) {
        return new eo(this.e_, t.key, t, e, n, this.Kc);
    }, t;
}(), ho = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, cn(t), n, r) || this).m_ = t, t.length % 2 != 1) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.$() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new Ji(new Q$1(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = R$1.t()), Wr("CollectionReference.doc", "non-empty string", 1, t);
        var e = B.N(t);
        return Ji.Zl(this.c_.path.child(e), this.firestore, this.Kc);
    }, n.prototype.add = function(t) {
        zr("CollectionReference.add", arguments, 1), Wr("CollectionReference.add", "object", 1, this.Kc ? this.Kc.toFirestore(t) : t);
        var e = this.doc();
...
function fo(t, e) {
    ...
    if (ni(t, e, [ "merge", "mergeFields" ]), Hr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + ti(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new x$1(F$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + ti(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof fi;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new x$1(F$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}

function lo(t, e) {
    return void 0 === e ? {} : (ni(t, e, [ "serverTimestamps" ]), $r(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function po(t, e) {
    Qr(t, "object", 1, e), e && (ni(t, e, [ "source" ]), $r(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}

function yo(t, e, n) {
    if (e instanceof Ai) {
        if (e.firestore !== n) throw new x$1(F$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
var mo = {
    ...
    DocumentSnapshot: to,
    Query: ao,
    QueryDocumentSnapshot: eo,
    QuerySnapshot: co,
    CollectionReference: ho,
    FieldPath: fi,
    FieldValue: bi,
    setLogLevel: Hi.setLogLevel,
 ...
 */ function wo(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new Component("firestore", (function(t) {
            return function(t, e) {
                return new Hi(t, e, new Mr, new Fr);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, mo)));
